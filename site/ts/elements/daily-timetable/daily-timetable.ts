...
export class StudentDailyTimetable extends Page {
    ...
    renderPage() {
        const currentBellIndex = getCurrentBellIndex(this.dailyTimetable, new Date());
        const nextBell = currentBellIndex === undefined ? undefined : this.dailyTimetable.timetable[currentBellIndex + 1];
        const nextVisibleBell = currentBellIndex === undefined ? undefined : this.dailyTimetable.timetable.slice(currentBellIndex + 1).find(bell => bell.shouldDisplay);
