...
::slotted(img) {
    ...
    cursor: pointer;
        ...
        `}};A.styles=[Ce,ke,Pe],y([E({type:String})],A.prototype,"pageName",2),y([E({type:Boolean})],A.prototype,"extension",2),y([E({type:String})],A.prototype,"title",2),y([E({type:Boolean})],A.prototype,"editing",2),A=y([F("nav-item")],A);var Re=$`:host {
    flex-shrink: 0;
