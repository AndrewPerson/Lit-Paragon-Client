...
::slotted(img) {
    ...
    cursor: pointer;
        ...
        `}};x.styles=[ke,Ae,Ce],f([_({type:String})],x.prototype,"pageName",2),f([_({type:Boolean})],x.prototype,"extension",2),f([_({type:String})],x.prototype,"title",2),f([_({type:Boolean})],x.prototype,"editing",2),x=f([W("nav-item")],x);var Re=w`:host {
    flex-shrink: 0;
...
#right-shadow {
    ...
    right: 0;
    --angle: -90deg;
}`;var m=class extends b{constructor(){super();this.editing=!1;this.pages=[];this.icons=[];this.order=[];this.draggedNavItemIndex=0;this.GetNavItem=((e,t)=>{let i,s,o,r=!1;return e<m.defaultPages.length?{page:i,title:s,icon:o}=m.defaultPages[e]:(i=this.pages[e-m.defaultPages.length],s=this.pages[e-m.defaultPages.length],o=this.icons[e-m.defaultPages.length],r=!0),P`
