(() => {
  ...
  var styles = r``;
  var default_default = styles;

  // site/js/navbar/navbar.css
  var styles2 = r`:host {
    flex-shrink: 0;
...
#right-shadow {
  ...
  var navbar_default = styles2;

  // site/js/navbar/navitem.css
  var styles3 = r`:host {
...
::slotted(img) {
  ...
  NavItem.styles = [default_default, navitem_default];
  __decorateClass([
    e4({ type: String })
  ...
  Navbar.styles = [default_default, navbar_default];
  Navbar.defaultPages = [
    {
      page: "dailytimetable",
