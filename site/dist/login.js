...
::slotted(img) {
    ...
    cursor: pointer;
        ...
        ${this.editing?L`<img id="handle" src="images/drag.svg" draggable="false">`:g}
        `}};A.styles=[Ce,ke,Te],f([S({type:String})],A.prototype,"pageName",2),f([S({type:Boolean})],A.prototype,"extension",2),f([S({type:String})],A.prototype,"title",2),f([S({type:Boolean})],A.prototype,"editing",2),A=f([K("nav-item")],A);var Pe=b`:host {
    flex-shrink: 0;
...
#right-shadow {
    ...
    right: 0;
    --angle: -90deg;
}`;var u=class extends ${constructor(){super();this.editing=!1;this.pages=[];this.icons=[];this.order=[];this.draggedNavItemIndex=0;this.GetNavItem=((e,t)=>{let i,s,n,o=!1;return e<u.defaultPages.length?{page:i,title:s,icon:n}=u.defaultPages[e]:(i=this.pages[e-u.defaultPages.length],s=this.pages[e-u.defaultPages.length],n=this.icons[e-u.defaultPages.length],o=!0),L`
