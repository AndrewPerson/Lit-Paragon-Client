...
::slotted(img) {
    ...
    cursor: pointer;
        ...
        `}};S.styles=[ke,Ae,Ce],f([E({type:String})],S.prototype,"pageName",2),f([E({type:Boolean})],S.prototype,"extension",2),f([E({type:String})],S.prototype,"title",2),f([E({type:Boolean})],S.prototype,"editing",2),S=f([W("nav-item")],S);var Te=w`:host {
    flex-shrink: 0;
