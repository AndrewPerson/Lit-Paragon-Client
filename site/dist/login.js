...
`;var Se=b`:where(h1, h2, h3, h4, h5, h6, p) {
    margin: 0;
}
...
::slotted(img) {
    ...
    cursor: pointer;
        ...
        `}};A.styles=[Se,ke,Ce],y([w({type:String})],A.prototype,"pageName",2),y([w({type:Boolean})],A.prototype,"extension",2),y([w({type:String})],A.prototype,"title",2),y([w({type:Boolean})],A.prototype,"editing",2),A=y([J("nav-item")],A);var Re=b`:host {
    flex-shrink: 0;
