...
::slotted(img) {
    ...
    cursor: pointer;
        ...
        `}};A.styles=[Se,ke,Ce],y([w({type:String})],A.prototype,"pageName",2),y([w({type:Boolean})],A.prototype,"extension",2),y([w({type:String})],A.prototype,"title",2),y([w({type:Boolean})],A.prototype,"editing",2),A=y([F("nav-item")],A);var Re=_`:host {
    flex-shrink: 0;
