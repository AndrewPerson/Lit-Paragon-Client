...
announcement-post {
    margin-bottom: 1.2rem;
        ...
        <div class="content">${t.map(i=>{let r=i.isMeeting==1,o=i.meetingDate??"";return new Date().toISOString().split("T")[0]==o&&(o=""),m`
            ...
            `})}</div>
        `}};G.styles=[w,T,be,ut,R,ee,gt],a([C()],G.prototype,"announcements",2),a([C()],G.prototype,"yearFilter",2),a([C()],G.prototype,"searchFilter",2),G=a([v("school-announcements")],G);var ft=h`:host {
    position: relative;
    display: block;
}
...
.background {
    ...
    clip-path: polygon(0 0, 100% 100%, 0 100%);
        ...
        `}};te.styles=[T,ft],a([_("slot")],te.prototype,"info",2),a([_(".background")],te.prototype,"background",2),te=a([v("info-popup")],te);var bt=h`:host {
    position: relative;
...
#save > svg {
    ...
    height: inherit;
        ...
        `}};j.styles=[w,T,R,ee,bt],a([_("#barcodeDisplay")],j.prototype,"barcode",2),a([_("#point1")],j.prototype,"point1",2),a([_("#point2")],j.prototype,"point2",2),a([_("#save")],j.prototype,"saveLink",2),j=a([v("student-barcode")],j);var xt=h`:host {
    display: flex;
    justify-content: space-between;
...
.periods {
    ...
    width: 80%;
        ...
        `;return this._dailyTimetableChanged=!1,this._savedPeriodsHtml=p,S}};B.styles=[w,R,ye,$t],B.updatingData=!1,a([C()],B.prototype,"_dailyTimetable",2),B=a([v("daily-timetable")],B);var Et=h`:host {
    overflow: hidden;
    display: flex;
    align-items: center;
    justify-content: center;
...
iframe {
    ...
    border: none;
        ...
        `}};Z.styles=Ct,a([u({type:String})],Z.prototype,"src",2),a([_("iframe",!0)],Z.prototype,"frame",2),a([_("loading-indicator",!0)],Z.prototype,"loader",2),Z=a([v("extension-page")],Z);var we=h`a.button {
    text-decoration: none;
    cursor: default;
}
...
.content {
    ...
    flex: 1;
        ...
        `}};q.styles=[w,we,_t],a([u()],q.prototype,"title",2),a([u()],q.prototype,"img",2),a([u()],q.prototype,"description",2),a([u({type:Boolean})],q.prototype,"installed",2),q=a([v("extension-display")],q);var At=h`:host {
    display: flex;
    flex-direction: column;
    gap: 1.2rem;
...
.content:empty::after {
    ...
    font-size: 1.4rem;
        ...
        `)}</div>
        `}
        `}};ce.styles=[w,be,R,ee,At],a([C()],ce.prototype,"extensions",2),ce=a([v("extensions-marketplace")],ce);var St=h`:host {
    position: relative;
    display: flex;
    align-items: flex-start;
    justify-content: space-between;
...
info-popup {
    ...
    z-index: 2;
        ...
        `}};re.styles=[w,T,we,Mt,ye,R,Rt],a([_("#hue",!0)],re.prototype,"hueInput",2),a([C()],re.prototype,"version",2),re=a([v("user-settings")],re);var Pt=h`:host {
    position: relative;
    display: flex;
    align-items: center;
    justify-content: center;
