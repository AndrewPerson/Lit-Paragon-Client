var Nt=Object.defineProperty;var It=Object.getOwnPropertyDescriptor;var n=(s,e,t,i)=>{for(var r=i>1?void 0:i?It(e,t):e,o=s.length-1,a;o>=0;o--)(a=s[o])&&(r=(i?a(e,t,r):a(r))||r);return i&&r&&Nt(e,t,r),r};var S=class{static ShowLoginNotification(){let e=document.createElement("p");e.innerHTML="You need to <a>login</a> to see the latest information.",g.ShowNotification(e)}static async GetToken(){let t=await(await caches.open("User Resources")).match("Token");if(!t)return location.href=`${location.origin}/login`,{valid:!1,token:null};let i=await t.json();return new Date>i.termination?(this.ShowLoginNotification(),{valid:!1,token:null}):{valid:!0,token:i}}static async SetResources(e){let t=await caches.open("User Resources"),i=[];e.forEach(r=>{let o=r.name,a=r.resource;i.push(t.put(o,new Response(a)).then(()=>this._resourceCallbacks.get(o)?.Invoke(JSON.parse(a))))}),await Promise.all(i)}static async SetResource(e,t){await(await caches.open("User Resources")).put(e,new Response(t)),this._resourceCallbacks.get(e)?.Invoke(JSON.parse(t))}static async GetResourceNow(e){let i=await(await caches.open("User Resources")).match(e);if(i)return await i.json()}static async GetResource(e,t){let i=this._resourceCallbacks.get(e);i!==void 0&&(i.AddListener(t),this._resourceCallbacks.set(e,i)),t(await this.GetResourceNow(e))}static async FetchResources(){let{valid:e,token:t}=await this.GetToken();if(!e)return!1;let i=new URL("https://sbhs-random-data.profsmart.repl.co/resources");i.searchParams.append("token",JSON.stringify(t));let r=await fetch(i.toString());if(!r.ok)return this.ShowLoginNotification(),!1;let o=await r.json();return await(await caches.open("User Resources")).put("Token",new Response(JSON.stringify(o.token))),await this.SetResources(Object.keys(o.result).map(u=>({name:u,resource:JSON.stringify(o.result[u])}))),!0}};S._resourceCallbacks=new Map;var G=class{constructor(){this._callbacks=[]}AddListener(e){this._callbacks.push(e)}Invoke(e){for(let t of this._callbacks)t(e)}};var ue=window.ShadowRoot&&(window.ShadyCSS===void 0||window.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,$e=Symbol(),Re=new Map,ge=class{constructor(e,t){if(this._$cssResult$=!0,t!==$e)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e}get styleSheet(){let e=Re.get(this.cssText);return ue&&e===void 0&&(Re.set(this.cssText,e=new CSSStyleSheet),e.replaceSync(this.cssText)),e}toString(){return this.cssText}},Me=s=>new ge(typeof s=="string"?s:s+"",$e),d=(s,...e)=>{let t=s.length===1?s[0]:e.reduce((i,r,o)=>i+(a=>{if(a._$cssResult$===!0)return a.cssText;if(typeof a=="number")return a;throw Error("Value passed to 'css' function must be a 'css' function result: "+a+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(r)+s[o+1],s[0]);return new ge(t,$e)},Ee=(s,e)=>{ue?s.adoptedStyleSheets=e.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet):e.forEach(t=>{let i=document.createElement("style"),r=window.litNonce;r!==void 0&&i.setAttribute("nonce",r),i.textContent=t.cssText,s.appendChild(i)})},fe=ue?s=>s:s=>s instanceof CSSStyleSheet?(e=>{let t="";for(let i of e.cssRules)t+=i.cssText;return Me(t)})(s):s;var ke,He=window.trustedTypes,Ut=He?He.emptyScript:"",Ne=window.reactiveElementPolyfillSupport,_e={toAttribute(s,e){switch(e){case Boolean:s=s?Ut:null;break;case Object:case Array:s=s==null?s:JSON.stringify(s)}return s},fromAttribute(s,e){let t=s;switch(e){case Boolean:t=s!==null;break;case Number:t=s===null?null:Number(s);break;case Object:case Array:try{t=JSON.parse(s)}catch{t=null}}return t}},Ie=(s,e)=>e!==s&&(e==e||s==s),Ce={attribute:!0,type:String,converter:_e,reflect:!1,hasChanged:Ie},I=class extends HTMLElement{constructor(){super(),this._$Et=new Map,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Ei=null,this.o()}static addInitializer(e){var t;(t=this.l)!==null&&t!==void 0||(this.l=[]),this.l.push(e)}static get observedAttributes(){this.finalize();let e=[];return this.elementProperties.forEach((t,i)=>{let r=this._$Eh(i,t);r!==void 0&&(this._$Eu.set(r,i),e.push(r))}),e}static createProperty(e,t=Ce){if(t.state&&(t.attribute=!1),this.finalize(),this.elementProperties.set(e,t),!t.noAccessor&&!this.prototype.hasOwnProperty(e)){let i=typeof e=="symbol"?Symbol():"__"+e,r=this.getPropertyDescriptor(e,i,t);r!==void 0&&Object.defineProperty(this.prototype,e,r)}}static getPropertyDescriptor(e,t,i){return{get(){return this[t]},set(r){let o=this[e];this[t]=r,this.requestUpdate(e,o,i)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)||Ce}static finalize(){if(this.hasOwnProperty("finalized"))return!1;this.finalized=!0;let e=Object.getPrototypeOf(this);if(e.finalize(),this.elementProperties=new Map(e.elementProperties),this._$Eu=new Map,this.hasOwnProperty("properties")){let t=this.properties,i=[...Object.getOwnPropertyNames(t),...Object.getOwnPropertySymbols(t)];for(let r of i)this.createProperty(r,t[r])}return this.elementStyles=this.finalizeStyles(this.styles),!0}static finalizeStyles(e){let t=[];if(Array.isArray(e)){let i=new Set(e.flat(1/0).reverse());for(let r of i)t.unshift(fe(r))}else e!==void 0&&t.push(fe(e));return t}static _$Eh(e,t){let i=t.attribute;return i===!1?void 0:typeof i=="string"?i:typeof e=="string"?e.toLowerCase():void 0}o(){var e;this._$Ep=new Promise(t=>this.enableUpdating=t),this._$AL=new Map,this._$Em(),this.requestUpdate(),(e=this.constructor.l)===null||e===void 0||e.forEach(t=>t(this))}addController(e){var t,i;((t=this._$Eg)!==null&&t!==void 0?t:this._$Eg=[]).push(e),this.renderRoot!==void 0&&this.isConnected&&((i=e.hostConnected)===null||i===void 0||i.call(e))}removeController(e){var t;(t=this._$Eg)===null||t===void 0||t.splice(this._$Eg.indexOf(e)>>>0,1)}_$Em(){this.constructor.elementProperties.forEach((e,t)=>{this.hasOwnProperty(t)&&(this._$Et.set(t,this[t]),delete this[t])})}createRenderRoot(){var e;let t=(e=this.shadowRoot)!==null&&e!==void 0?e:this.attachShadow(this.constructor.shadowRootOptions);return Ee(t,this.constructor.elementStyles),t}connectedCallback(){var e;this.renderRoot===void 0&&(this.renderRoot=this.createRenderRoot()),this.enableUpdating(!0),(e=this._$Eg)===null||e===void 0||e.forEach(t=>{var i;return(i=t.hostConnected)===null||i===void 0?void 0:i.call(t)})}enableUpdating(e){}disconnectedCallback(){var e;(e=this._$Eg)===null||e===void 0||e.forEach(t=>{var i;return(i=t.hostDisconnected)===null||i===void 0?void 0:i.call(t)})}attributeChangedCallback(e,t,i){this._$AK(e,i)}_$ES(e,t,i=Ce){var r,o;let a=this.constructor._$Eh(e,i);if(a!==void 0&&i.reflect===!0){let u=((o=(r=i.converter)===null||r===void 0?void 0:r.toAttribute)!==null&&o!==void 0?o:_e.toAttribute)(t,i.type);this._$Ei=e,u==null?this.removeAttribute(a):this.setAttribute(a,u),this._$Ei=null}}_$AK(e,t){var i,r,o;let a=this.constructor,u=a._$Eu.get(e);if(u!==void 0&&this._$Ei!==u){let h=a.getPropertyOptions(u),m=h.converter,L=(o=(r=(i=m)===null||i===void 0?void 0:i.fromAttribute)!==null&&r!==void 0?r:typeof m=="function"?m:null)!==null&&o!==void 0?o:_e.fromAttribute;this._$Ei=u,this[u]=L(t,h.type),this._$Ei=null}}requestUpdate(e,t,i){let r=!0;e!==void 0&&(((i=i||this.constructor.getPropertyOptions(e)).hasChanged||Ie)(this[e],t)?(this._$AL.has(e)||this._$AL.set(e,t),i.reflect===!0&&this._$Ei!==e&&(this._$E_===void 0&&(this._$E_=new Map),this._$E_.set(e,i))):r=!1),!this.isUpdatePending&&r&&(this._$Ep=this._$EC())}async _$EC(){this.isUpdatePending=!0;try{await this._$Ep}catch(t){Promise.reject(t)}let e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){var e;if(!this.isUpdatePending)return;this.hasUpdated,this._$Et&&(this._$Et.forEach((r,o)=>this[o]=r),this._$Et=void 0);let t=!1,i=this._$AL;try{t=this.shouldUpdate(i),t?(this.willUpdate(i),(e=this._$Eg)===null||e===void 0||e.forEach(r=>{var o;return(o=r.hostUpdate)===null||o===void 0?void 0:o.call(r)}),this.update(i)):this._$EU()}catch(r){throw t=!1,this._$EU(),r}t&&this._$AE(i)}willUpdate(e){}_$AE(e){var t;(t=this._$Eg)===null||t===void 0||t.forEach(i=>{var r;return(r=i.hostUpdated)===null||r===void 0?void 0:r.call(i)}),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$EU(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$Ep}shouldUpdate(e){return!0}update(e){this._$E_!==void 0&&(this._$E_.forEach((t,i)=>this._$ES(i,this[i],t)),this._$E_=void 0),this._$EU()}updated(e){}firstUpdated(e){}};I.finalized=!0,I.elementProperties=new Map,I.elementStyles=[],I.shadowRootOptions={mode:"open"},Ne==null||Ne({ReactiveElement:I}),((ke=globalThis.reactiveElementVersions)!==null&&ke!==void 0?ke:globalThis.reactiveElementVersions=[]).push("1.0.2");var Se,V=globalThis.trustedTypes,Ue=V?V.createPolicy("lit-html",{createHTML:s=>s}):void 0,U=`lit$${(Math.random()+"").slice(9)}$`,Oe="?"+U,Ot=`<${Oe}>`,Z=document,oe=(s="")=>Z.createComment(s),ae=s=>s===null||typeof s!="object"&&typeof s!="function",De=Array.isArray,Dt=s=>{var e;return De(s)||typeof((e=s)===null||e===void 0?void 0:e[Symbol.iterator])=="function"},ne=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,ze=/-->/g,je=/>/g,z=/>|[ 	\n\r](?:([^\s"'>=/]+)([ 	\n\r]*=[ 	\n\r]*(?:[^ 	\n\r"'`<>=]|("|')|))|$)/g,Be=/'/g,qe=/"/g,Fe=/^(?:script|style|textarea)$/i,Ge=s=>(e,...t)=>({_$litType$:s,strings:e,values:t}),c=Ge(1),W=Ge(2),N=Symbol.for("lit-noChange"),b=Symbol.for("lit-nothing"),Ve=new WeakMap,Ze=(s,e,t)=>{var i,r;let o=(i=t==null?void 0:t.renderBefore)!==null&&i!==void 0?i:e,a=o._$litPart$;if(a===void 0){let u=(r=t==null?void 0:t.renderBefore)!==null&&r!==void 0?r:null;o._$litPart$=a=new X(e.insertBefore(oe(),u),u,void 0,t??{})}return a._$AI(s),a},J=Z.createTreeWalker(Z,129,null,!1),zt=(s,e)=>{let t=s.length-1,i=[],r,o=e===2?"<svg>":"",a=ne;for(let h=0;h<t;h++){let m=s[h],L,y,E=-1,P=0;for(;P<m.length&&(a.lastIndex=P,y=a.exec(m),y!==null);)P=a.lastIndex,a===ne?y[1]==="!--"?a=ze:y[1]!==void 0?a=je:y[2]!==void 0?(Fe.test(y[2])&&(r=RegExp("</"+y[2],"g")),a=z):y[3]!==void 0&&(a=z):a===z?y[0]===">"?(a=r??ne,E=-1):y[1]===void 0?E=-2:(E=a.lastIndex-y[2].length,L=y[1],a=y[3]===void 0?z:y[3]==='"'?qe:Be):a===qe||a===Be?a=z:a===ze||a===je?a=ne:(a=z,r=void 0);let pe=a===z&&s[h+1].startsWith("/>")?" ":"";o+=a===ne?m+Ot:E>=0?(i.push(L),m.slice(0,E)+"$lit$"+m.slice(E)+U+pe):m+U+(E===-2?(i.push(void 0),h):pe)}let u=o+(s[t]||"<?>")+(e===2?"</svg>":"");return[Ue!==void 0?Ue.createHTML(u):u,i]},Y=class{constructor({strings:e,_$litType$:t},i){let r;this.parts=[];let o=0,a=0,u=e.length-1,h=this.parts,[m,L]=zt(e,t);if(this.el=Y.createElement(m,i),J.currentNode=this.el.content,t===2){let y=this.el.content,E=y.firstChild;E.remove(),y.append(...E.childNodes)}for(;(r=J.nextNode())!==null&&h.length<u;){if(r.nodeType===1){if(r.hasAttributes()){let y=[];for(let E of r.getAttributeNames())if(E.endsWith("$lit$")||E.startsWith(U)){let P=L[a++];if(y.push(E),P!==void 0){let pe=r.getAttribute(P.toLowerCase()+"$lit$").split(U),me=/([.?@])?(.*)/.exec(P);h.push({type:1,index:o,name:me[2],strings:pe,ctor:me[1]==="."?Je:me[1]==="?"?Ye:me[1]==="@"?Ke:le})}else h.push({type:6,index:o})}for(let E of y)r.removeAttribute(E)}if(Fe.test(r.tagName)){let y=r.textContent.split(U),E=y.length-1;if(E>0){r.textContent=V?V.emptyScript:"";for(let P=0;P<E;P++)r.append(y[P],oe()),J.nextNode(),h.push({type:2,index:++o});r.append(y[E],oe())}}}else if(r.nodeType===8)if(r.data===Oe)h.push({type:2,index:o});else{let y=-1;for(;(y=r.data.indexOf(U,y+1))!==-1;)h.push({type:7,index:o}),y+=U.length-1}o++}}static createElement(e,t){let i=Z.createElement("template");return i.innerHTML=e,i}};function K(s,e,t=s,i){var r,o,a,u;if(e===N)return e;let h=i!==void 0?(r=t._$Cl)===null||r===void 0?void 0:r[i]:t._$Cu,m=ae(e)?void 0:e._$litDirective$;return(h==null?void 0:h.constructor)!==m&&((o=h==null?void 0:h._$AO)===null||o===void 0||o.call(h,!1),m===void 0?h=void 0:(h=new m(s),h._$AT(s,t,i)),i!==void 0?((a=(u=t)._$Cl)!==null&&a!==void 0?a:u._$Cl=[])[i]=h:t._$Cu=h),h!==void 0&&(e=K(s,h._$AS(s,e.values),h,i)),e}var We=class{constructor(e,t){this.v=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}p(e){var t;let{el:{content:i},parts:r}=this._$AD,o=((t=e==null?void 0:e.creationScope)!==null&&t!==void 0?t:Z).importNode(i,!0);J.currentNode=o;let a=J.nextNode(),u=0,h=0,m=r[0];for(;m!==void 0;){if(u===m.index){let L;m.type===2?L=new X(a,a.nextSibling,this,e):m.type===1?L=new m.ctor(a,m.name,m.strings,this,e):m.type===6&&(L=new Xe(a,this,e)),this.v.push(L),m=r[++h]}u!==(m==null?void 0:m.index)&&(a=J.nextNode(),u++)}return o}m(e){let t=0;for(let i of this.v)i!==void 0&&(i.strings!==void 0?(i._$AI(e,i,t),t+=i.strings.length-2):i._$AI(e[t])),t++}},X=class{constructor(e,t,i,r){var o;this.type=2,this._$AH=b,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=i,this.options=r,this._$Cg=(o=r==null?void 0:r.isConnected)===null||o===void 0||o}get _$AU(){var e,t;return(t=(e=this._$AM)===null||e===void 0?void 0:e._$AU)!==null&&t!==void 0?t:this._$Cg}get parentNode(){let e=this._$AA.parentNode,t=this._$AM;return t!==void 0&&e.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=K(this,e,t),ae(e)?e===b||e==null||e===""?(this._$AH!==b&&this._$AR(),this._$AH=b):e!==this._$AH&&e!==N&&this.$(e):e._$litType$!==void 0?this.T(e):e.nodeType!==void 0?this.S(e):Dt(e)?this.M(e):this.$(e)}A(e,t=this._$AB){return this._$AA.parentNode.insertBefore(e,t)}S(e){this._$AH!==e&&(this._$AR(),this._$AH=this.A(e))}$(e){this._$AH!==b&&ae(this._$AH)?this._$AA.nextSibling.data=e:this.S(Z.createTextNode(e)),this._$AH=e}T(e){var t;let{values:i,_$litType$:r}=e,o=typeof r=="number"?this._$AC(e):(r.el===void 0&&(r.el=Y.createElement(r.h,this.options)),r);if(((t=this._$AH)===null||t===void 0?void 0:t._$AD)===o)this._$AH.m(i);else{let a=new We(o,this),u=a.p(this.options);a.m(i),this.S(u),this._$AH=a}}_$AC(e){let t=Ve.get(e.strings);return t===void 0&&Ve.set(e.strings,t=new Y(e)),t}M(e){De(this._$AH)||(this._$AH=[],this._$AR());let t=this._$AH,i,r=0;for(let o of e)r===t.length?t.push(i=new X(this.A(oe()),this.A(oe()),this,this.options)):i=t[r],i._$AI(o),r++;r<t.length&&(this._$AR(i&&i._$AB.nextSibling,r),t.length=r)}_$AR(e=this._$AA.nextSibling,t){var i;for((i=this._$AP)===null||i===void 0||i.call(this,!1,!0,t);e&&e!==this._$AB;){let r=e.nextSibling;e.remove(),e=r}}setConnected(e){var t;this._$AM===void 0&&(this._$Cg=e,(t=this._$AP)===null||t===void 0||t.call(this,e))}},le=class{constructor(e,t,i,r,o){this.type=1,this._$AH=b,this._$AN=void 0,this.element=e,this.name=t,this._$AM=r,this.options=o,i.length>2||i[0]!==""||i[1]!==""?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=b}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(e,t=this,i,r){let o=this.strings,a=!1;if(o===void 0)e=K(this,e,t,0),a=!ae(e)||e!==this._$AH&&e!==N,a&&(this._$AH=e);else{let u=e,h,m;for(e=o[0],h=0;h<o.length-1;h++)m=K(this,u[i+h],t,h),m===N&&(m=this._$AH[h]),a||(a=!ae(m)||m!==this._$AH[h]),m===b?e=b:e!==b&&(e+=(m??"")+o[h+1]),this._$AH[h]=m}a&&!r&&this.k(e)}k(e){e===b?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}},Je=class extends le{constructor(){super(...arguments),this.type=3}k(e){this.element[this.name]=e===b?void 0:e}},jt=V?V.emptyScript:"",Ye=class extends le{constructor(){super(...arguments),this.type=4}k(e){e&&e!==b?this.element.setAttribute(this.name,jt):this.element.removeAttribute(this.name)}},Ke=class extends le{constructor(e,t,i,r,o){super(e,t,i,r,o),this.type=5}_$AI(e,t=this){var i;if((e=(i=K(this,e,t,0))!==null&&i!==void 0?i:b)===N)return;let r=this._$AH,o=e===b&&r!==b||e.capture!==r.capture||e.once!==r.once||e.passive!==r.passive,a=e!==b&&(r===b||o);o&&this.element.removeEventListener(this.name,this,r),a&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){var t,i;typeof this._$AH=="function"?this._$AH.call((i=(t=this.options)===null||t===void 0?void 0:t.host)!==null&&i!==void 0?i:this.element,e):this._$AH.handleEvent(e)}},Xe=class{constructor(e,t,i){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(e){K(this,e)}};var Qe=window.litHtmlPolyfillSupport;Qe==null||Qe(Y,X),((Se=globalThis.litHtmlVersions)!==null&&Se!==void 0?Se:globalThis.litHtmlVersions=[]).push("2.0.2");var Ae,Te;var v=class extends I{constructor(){super(...arguments),this.renderOptions={host:this},this._$Dt=void 0}createRenderRoot(){var e,t;let i=super.createRenderRoot();return(e=(t=this.renderOptions).renderBefore)!==null&&e!==void 0||(t.renderBefore=i.firstChild),i}update(e){let t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Dt=Ze(t,this.renderRoot,this.renderOptions)}connectedCallback(){var e;super.connectedCallback(),(e=this._$Dt)===null||e===void 0||e.setConnected(!0)}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this._$Dt)===null||e===void 0||e.setConnected(!1)}render(){return N}};v.finalized=!0,v._$litElement$=!0,(Ae=globalThis.litElementHydrateSupport)===null||Ae===void 0||Ae.call(globalThis,{LitElement:v});var et=globalThis.litElementPolyfillSupport;et==null||et({LitElement:v});((Te=globalThis.litElementVersions)!==null&&Te!==void 0?Te:globalThis.litElementVersions=[]).push("3.0.2");var f=s=>e=>typeof e=="function"?((t,i)=>(window.customElements.define(t,i),i))(s,e):((t,i)=>{let{kind:r,elements:o}=i;return{kind:r,elements:o,finisher(a){window.customElements.define(t,a)}}})(s,e);var Bt=(s,e)=>e.kind==="method"&&e.descriptor&&!("value"in e.descriptor)?{...e,finisher(t){t.createProperty(e.key,s)}}:{kind:"field",key:Symbol(),placement:"own",descriptor:{},originalKey:e.key,initializer(){typeof e.initializer=="function"&&(this[e.key]=e.initializer.call(this))},finisher(t){t.createProperty(e.key,s)}};function p(s){return(e,t)=>t!==void 0?((i,r,o)=>{r.constructor.createProperty(o,i)})(s,e,t):Bt(s,e)}function _(s){return p({...s,state:!0})}var Q=({finisher:s,descriptor:e})=>(t,i)=>{var r;if(i===void 0){let o=(r=t.originalKey)!==null&&r!==void 0?r:t.key,a=e!=null?{kind:"method",placement:"prototype",key:o,descriptor:e(t.key)}:{...t,key:o};return s!=null&&(a.finisher=function(u){s(u,o)}),a}{let o=t.constructor;e!==void 0&&Object.defineProperty(t,i,e(i)),s==null||s(o,i)}};function k(s,e){return Q({descriptor:t=>{let i={get(){var r,o;return(o=(r=this.renderRoot)===null||r===void 0?void 0:r.querySelector(s))!==null&&o!==void 0?o:null},enumerable:!0,configurable:!0};if(e){let r=typeof t=="symbol"?Symbol():"__"+t;i.get=function(){var o,a;return this[r]===void 0&&(this[r]=(a=(o=this.renderRoot)===null||o===void 0?void 0:o.querySelector(s))!==null&&a!==void 0?a:null),this[r]}}return i}})}var A=d`:where(img, svg) {
...
::slotted(img) {
    ...
    cursor: pointer;
        ...
        `}};O.styles=[x,A,tt],n([p({type:String})],O.prototype,"pageName",2),n([p({type:Boolean})],O.prototype,"extension",2),n([p({type:String})],O.prototype,"title",2),n([p({type:Boolean})],O.prototype,"editing",2),O=n([f("nav-item")],O);var it=d`:host {
    flex-shrink: 0;
...
#right-shadow {
    ...
    right: 0;
    --angle: -90deg;
}`;var w=class extends v{constructor(){super();this.editing=!1;this.pages=[];this.icons=[];this.order=[];this.draggedNavItemIndex=0;this.GetNavItem=((e,t)=>{let i,r,o,a=!1;return e<w.defaultPages.length?{page:i,title:r,icon:o}=w.defaultPages[e]:(i=this.pages[e-w.defaultPages.length],r=this.pages[e-w.defaultPages.length],o=this.icons[e-w.defaultPages.length],a=!0),c`
            <nav-item ?editing="${this.editing}" pageName="${i}" ?extension="${a}" title="${r}" 
        ...
        `}};w.styles=it,w.defaultPages=[{page:"daily-timetable",title:"Daily Timetable",icon:"images/dailytimetable.svg"},{page:"barcode",title:"ID Barcode",icon:"images/barcode.svg"},{page:"timetable",title:"Timetable",icon:"images/timetable.svg"},{page:"announcements",title:"Announcements",icon:"images/announcements.svg"},{page:"pages",title:"Pages Marketplace",icon:"images/marketplace.svg"},{page:"settings",title:"Settings",icon:"images/settings.svg"}],n([p({type:Boolean})],w.prototype,"editing",2),n([k("#items-container",!0)],w.prototype,"itemsContainer",2),n([k("#top-shadow",!0)],w.prototype,"topShadow",2),n([k("#bottom-shadow",!0)],w.prototype,"bottomShadow",2),n([k("#left-shadow",!0)],w.prototype,"leftShadow",2),n([k("#right-shadow",!0)],w.prototype,"rightShadow",2),w=n([f("nav-bar")],w);var $=class{};$.installedExtensions=new Map(Object.entries(JSON.parse(localStorage.getItem("Installed Extensions")||"{}"))),$._extensionCallbacks=new G,$._resourceListeners=new Map;function qt(){let s=[];for(let e of $.installedExtensions.values())s.push(new URL(e.url).origin);return s}async function st(s){let e=(await Le()).get(s);if(e){$.installedExtensions.set(s,e),localStorage.setItem("Installed Extensions",JSON.stringify(Object.fromEntries($.installedExtensions)));let t=w.GetNavbarOrder();t.splice(t.length-1,0,t.length),w.SetNavbarOrder(t)}}async function ot(s){let e=$.installedExtensions,t=w.GetNavbarOrder(),i=t.indexOf(Object.keys(e).indexOf(s))+w.defaultPages.length,r=t.splice(i,1)[0];for(let a=0;a<t.length;a++)t[a]>r&&t[a]--;w.SetNavbarOrder(t);var o=document.getElementById(`extension-${s}`);o!==null&&o.remove(),$.installedExtensions.delete(s),localStorage.setItem("Installed Extensions",JSON.stringify(Object.fromEntries($.installedExtensions)))}async function Le(){let e=await(await caches.open("Metadata")).match("Metadata");return e?new Map(Object.entries((await e.json()).pages||{})):new Map}async function at(s){$._extensionCallbacks.AddListener(s),s(await Le())}async function nt(){let s=await Le();$._extensionCallbacks.Invoke(s)}function lt(s){let e=new URL(s.icon,s.url);return e.search=`cache-version=${s.version}`,e.toString()}function rt(s){let e=new URL(s.navIcon,s.url);return e.searchParams.set("cache-version",s.version),e.toString()}function dt(){g.ListenForDark(e=>{for(let t=0;t<window.frames.length;t++)window.frames[t].postMessage({command:"Set Dark",data:{dark:e}},"*")}),g.ListenForHue(e=>{for(let t=0;t<window.frames.length;t++)window.frames[t].postMessage({command:"Set Hue",data:{hue:e}},"*")}),window.addEventListener("message",async e=>{let t=e.origin;!qt().includes(t)||e.source?.postMessage(await s(e),{targetOrigin:t})});async function s(e){let t=e.data.command,i=e.data.data;if(t=="Initialise")return{command:"Initialise",data:{dark:g.dark,hue:g.hue,version:await g.GetVersion()}};if(t=="Get Resource"){let r=$._resourceListeners.get(i.name),o=!1;r===void 0&&(o=!0,r=[]),r.push(e),$._resourceListeners.set(i.name,r),o&&S.GetResource(i.name,u=>{let h=$._resourceListeners.get(i.name)??[];for(let m of h)m.source?.postMessage({command:"Resource",data:{name:i.name,resource:u}},{targetOrigin:m.origin})});let a=await S.GetResourceNow(i.name);return{command:"Resource",data:{name:i.name,resource:a}}}if(t=="Get Token"){let r=await S.GetToken();return{command:"Token",data:{token:r.token===null?null:r.token.access_token,valid:r.valid}}}if(t=="Refresh Token"){if(!await S.FetchResources())return{command:"Refreshed Token",data:{token:null,valid:!1}};let o=await S.GetToken();return{command:"Refreshed Token",data:{token:o.token===null?null:o.token.access_token,valid:o.valid}}}return t=="Ping"?{command:"Pong"}:{command:"Unknown Command",data:{command:t}}}}var g=class{static NavigateTo(e){if(e.extension){let t=$.installedExtensions;if(t.has(e.page)){let i=document.getElementById(`extension-${e.page}`);if(i===null){let r=document.createElement("extension-page");r.src=t.get(e.page).url,r.id=`extension-${e.page}`,document.querySelector("main")?.appendChild(r),i=r}this.SetPage(e,i)}}else this.SetPage(e,document.getElementById(e.page))}static SetPage(e,t){if(t){this._pageElement!=null&&this._pageElement.classList.add("hidden"),t.classList.remove("hidden"),this._pageElement=t,this.page=e,location.hash=e.extension?`extension-${e.page}`:e.page;let i=document.querySelector("nav-bar");i.removeAttribute("editing"),i.requestUpdate?.()}}static ShowNotification(e,t=!1){let i=document.createElement("inline-notification");return typeof e=="string"?i.innerText=e:i.appendChild(e),i.loader=t,document.getElementById("notification-area")?.appendChild(i),i}static SetDark(e){this.dark=e,document.documentElement.classList.toggle("dark",e),localStorage.setItem("Dark",e.toString()),this._darkCallbacks.Invoke(e)}static ListenForDark(e){this._darkCallbacks.AddListener(e)}static SetHue(e){document.documentElement.style.setProperty("--main-hue",e),document.documentElement.style.setProperty("--hue-rotate",`${parseFloat(e)-200}deg`),this.hue=e}static SaveHue(){localStorage.setItem("Hue",this.hue),this._hueCallbacks.Invoke(parseFloat(this.hue))}static ListenForHue(e){this._hueCallbacks.AddListener(e)}static async GetVersion(){var e=await caches.open("Metadata");let t=await e.match("Metadata");if(t)return(await t.json()).version}};g.page={page:"",extension:!1},g.dark=localStorage.getItem("Dark")=="true",g.hue=localStorage.getItem("Hue")||"200",g._pageElement=null,g._darkCallbacks=new G,g._hueCallbacks=new G;var H=class extends v{constructor(){super(...arguments);this._state=0;this._unreceivedResources=0;this._uncompletedResources=0}AddResource(e,t){this._unreceivedResources++,this._uncompletedResources++;let i=!1,r=!1;S.GetResource(e,o=>{i||(this._unreceivedResources--,i=!0),o!=null&&(r||(this._uncompletedResources--,r=!0),this[t]=o),this._uncompletedResources==0?this._state=2:this._unreceivedResources==0&&(this._state=1)})}render(){return this._state==0?b:this._state==1?c`
            ...
            `:this.renderPage()}renderPage(){return b}};n([_()],H.prototype,"_state",2);var ht={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},ct=s=>(...e)=>({_$litDirective$:s,values:e}),Pe=class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,i){this._$Ct=e,this._$AM=t,this._$Ci=i}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}};var ve=class extends Pe{constructor(e){if(super(e),this.it=b,e.type!==ht.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(e){if(e===b||e==null)return this.vt=void 0,this.it=e;if(e===N)return e;if(typeof e!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(e===this.it)return this.vt;this.it=e;let t=[e];return t.raw=t,this.vt={_$litType$:this.constructor.resultType,strings:t,values:[]}}};ve.directiveName="unsafeHTML",ve.resultType=1;var pt=ct(ve);var mt=d`:host {
    display: block;
}
...
.info {
    font-size: 0.7rem;
}`;var R=class extends v{render(){return c`
        <details>
            <summary>
                <h3>${this.title}</h3>
        ...
        `}};R.styles=[x,mt],n([p()],R.prototype,"title",2),n([p()],R.prototype,"author",2),n([p()],R.prototype,"years",2),n([p({type:Boolean})],R.prototype,"meeting",2),n([p()],R.prototype,"meetingTime",2),n([p()],R.prototype,"content",2),n([p({type:Number})],R.prototype,"weight",2),R=n([f("announcement-post")],R);var ye=d`:where(input[type=search]) {
    border: none;
...
announcement-post {
    margin-bottom: 1.2rem;
}`;var j=class extends H{constructor(){super();this.yearFilter="all";this.searchFilter="";this.AddResource("announcements","announcements")}renderPage(){let e=this.yearFilter=="all"?this.announcements.notices:this.announcements.notices.filter(t=>t.years.includes(this.yearFilter));return e=this.searchFilter==""?e:e.filter(t=>t.title.toLowerCase().includes(this.searchFilter.toLowerCase())||t.content.toLowerCase().includes(this.searchFilter.toLowerCase())),c`
        <div class="header">
        ...
        `)}</div>
        `}};j.styles=[T,ee,x,A,ye,ut,gt],n([_()],j.prototype,"announcements",2),n([_()],j.prototype,"yearFilter",2),n([_()],j.prototype,"searchFilter",2),j=n([f("school-announcements")],j);var ft=d`:host {
    position: relative;
    display: block;
}
...
.background {
    ...
    clip-path: polygon(0 0, 100% 100%, 0 100%);
        ...
        `}};te.styles=[A,ft],n([k("slot")],te.prototype,"info",2),n([k(".background")],te.prototype,"background",2),te=n([f("info-popup")],te);var yt=d`:host {
    position: relative;
...
info-popup {
    ...
    z-index: 2;
        ...
        `}};B.styles=[T,ee,x,A,yt],n([k("#barcodeDisplay")],B.prototype,"barcode",2),n([k("#point1")],B.prototype,"point1",2),n([k("#point2")],B.prototype,"point2",2),B=n([f("student-barcode")],B);var bt=d`:host {
    display: flex;
    justify-content: space-between;
...
p {
    color: var(--text3);
}`;var ie=class extends v{render(){return c`
            <p>${this.title}</p>
            <p>${this.time}</p>
        `}};ie.styles=[x,bt],n([p()],ie.prototype,"title",2),n([p()],ie.prototype,"time",2),ie=n([f("daily-timetable-bell")],ie);var be=d`:host, main {
    padding: 0.8rem;
...
.periods {
    ...
    width: 80%;
}`;var de=class extends H{constructor(){super();this.AddResource("dailytimetable","dailyTimetable")}GetBell(e){return c`<daily-timetable-bell title="${e.bellDisplay}" time="${e.time}"></daily-timetable-bell>`}GetPeriod(e,t,i){return c`
        ...
        `}renderPage(){let e=this.dailyTimetable.bells,t=this.dailyTimetable.timetable.timetable.periods,i=Array.isArray(this.dailyTimetable.roomVariations)?{}:this.dailyTimetable.roomVariations,r=Array.isArray(this.dailyTimetable.classVariations)?{}:this.dailyTimetable.classVariations;return c`
            ...
            <div class="periods">
                ${e.map(o=>{if(o.period in t){let a=t[o.period];return"fullTeacher"in a&&"year"in a?this.GetPeriod(t[o.period],i[o.period],r[o.period]):this.GetBell(o)}else return this.GetBell(o)})}
            </div>
        `}};de.styles=[T,be,x,wt],n([_()],de.prototype,"dailyTimetable",2),de=n([f("daily-timetable")],de);var xt=d`:host {
    overflow: hidden;
    display: flex;
    align-items: center;
    justify-content: center;
...
iframe {
    ...
    height: inherit;
    border: none;
}`;var q=class extends v{constructor(){super(...arguments);this.src=""}StopLoading(){this.loader.remove(),this.frame.removeAttribute("style")}render(){return c`
        ...
        `}};q.styles=Et,n([p({type:String})],q.prototype,"src",2),n([k("iframe",!0)],q.prototype,"frame",2),n([k("loading-indicator",!0)],q.prototype,"loader",2),q=n([f("extension-page")],q);var xe=d`a.button {
    text-decoration: none;
    cursor: default;
}
...
.content {
    ...
    flex: 1;
}`;var D=class extends v{async Install(){await st(this.title),document.getElementById("pages").requestUpdate()}async Uninstall(){await ot(this.title),document.getElementById("pages").requestUpdate()}render(){return c`
        <img src="${this.img}">
        ...
        `}};D.styles=[x,xe,kt],n([p()],D.prototype,"title",2),n([p()],D.prototype,"img",2),n([p()],D.prototype,"description",2),n([p({type:Boolean})],D.prototype,"installed",2),D=n([f("extension-display")],D);var _t=d`:host {
    display: flex;
    flex-direction: column;
    gap: 1.2rem;
...
.content:empty::after {
    ...
    font-size: 1.4rem;
}`;var he=class extends v{constructor(){super();this.fetchingExtensions=!0;this.extensions=new Map;at(e=>{this.fetchingExtensions=!1,this.extensions=e})}render(){let e=$.installedExtensions,t=[];for(var i of e.keys())t.push(i);return c`
        <div class="header">
        ...
        `)}</div>
        `}
        `}};he.styles=[T,ee,x,ye,_t],n([_()],he.prototype,"extensions",2),he=n([f("extensions-marketplace")],he);var Ct=d`:host {
    position: relative;
    display: flex;
    align-items: center;
    justify-content: space-between;
...
svg {
    width: inherit;
    height: inherit;
}`;var St=W`<svg width="220" height="220" viewBox="0 0 220 220" xmlns="http://www.w3.org/2000/svg"><g fill="none" stroke="#323232" stroke-width="10" stroke-linecap="round"><path d="m5 5 210 210M215 5 5 215"/></g></svg>`;var ce=class extends v{render(){return c`
        <slot></slot>
        ${this.loader?c`
        ...
        `}};ce.styles=[A,Ct],n([p({type:Boolean})],ce.prototype,"loader",2),ce=n([f("inline-notification")],ce);var At=d`:where(input[type=range]) {
    appearance: none;
    width: 7rem;
...
info-popup {
    ...
    --offset: 2.6rem;
    z-index: 2;
}`;var re=class extends v{constructor(){super();this.version="0.0.0";g.GetVersion().then(e=>this.version=e)}Patch(){}ResetColour(){this.hueInput.value="200",g.SetHue("200"),g.SaveHue()}ToggleDark(e){let t=e.target;g.SetDark(t.checked),this.requestUpdate()}ToggleEditNavbar(){let e=document.querySelector("nav-bar");e&&e.toggleAttribute("editing")}render(){return c`
        <info-popup>
        ...
        `}};re.styles=[x,A,xe,At,be,T,Tt],n([k("#hue",!0)],re.prototype,"hueInput",2),n([_()],re.prototype,"version",2),re=n([f("user-settings")],re);var Lt=d`:host {
    position: relative;
    display: flex;
    align-items: center;
    justify-content: center;
...
.highlighted {
    color: var(--text2);
}`;var F=class extends v{render(){return c`
        ...
        `}};F.styles=[x,Pt],n([p()],F.prototype,"name",2),n([p({type:Array})],F.prototype,"periods",2),n([p()],F.prototype,"day",2),F=n([f("timetable-day")],F);var Rt=d`:host {
    display: flex;
...
@media (max-aspect-ratio: 3/4) {
    .period-nums > p {
        ...
        `}};M.styles=[x,Rt],n([p()],M.prototype,"week",2),n([p({type:Object})],M.prototype,"day1",2),n([p({type:Object})],M.prototype,"day2",2),n([p({type:Object})],M.prototype,"day3",2),n([p({type:Object})],M.prototype,"day4",2),n([p({type:Object})],M.prototype,"day5",2),n([p()],M.prototype,"day",2),M=n([f("timetable-row")],M);var Mt=d`:host {
    margin: auto;
    padding: 1.6rem;
    max-width: 92%;
    width: 23rem;
...
}`;var se=class extends H{set dailyTimetable(e){this._day=e.timetable.timetable.dayname}ClearHighlight(){C.highlight("")}constructor(){super();this.AddResource("timetable","timetable"),this.AddResource("dailytimetable","dailyTimetable"),this.addEventListener("pointerover",e=>e.stopPropagation()),document.addEventListener("pointerover",this.ClearHighlight)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("pointerover",this.ClearHighlight)}renderPage(){return this._day=this._day.slice(0,3).toUpperCase()+" "+this._day.slice(-1),c`
