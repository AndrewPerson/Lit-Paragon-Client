var Ut=Object.defineProperty;var Ht=Object.getOwnPropertyDescriptor;var a=(s,e,t,r)=>{for(var i=r>1?void 0:r?Ht(e,t):e,o=s.length-1,n;o>=0;o--)(n=s[o])&&(i=(r?n(e,t,i):n(i))||i);return r&&i&&Ut(e,t,i),i};var H=class{constructor(){this._callbacks=[]}AddListener(e){this._callbacks.push(e)}Invoke(e){for(let t of this._callbacks)t(e)}};var A=class{static ShowLoginNotification(){let e=document.createElement("p");e.innerHTML="You need to <a>login</a> to see the latest information.",u.ShowNotification(e)}static async GetToken(){let t=await(await caches.open("User Resources")).match("Token");if(!t)return location.href=`${location.origin}/login`,{valid:!1,token:null};let r=await t.json();return new Date>r.termination?(this.ShowLoginNotification(),{valid:!1,token:null}):{valid:!0,token:r}}static async SetResources(e){let t=await caches.open("User Resources"),r=e.map(i=>{let o=i.name,n=i.resource;return t.put(o,new Response(n)).then(()=>this._resourceCallbacks.get(o)?.Invoke(JSON.parse(n)))});await Promise.all(r)}static async SetResource(e,t){await(await caches.open("User Resources")).put(e,new Response(t)),this._resourceCallbacks.get(e)?.Invoke(JSON.parse(t))}static async GetResourceNow(e){let r=await(await caches.open("User Resources")).match(e);if(r)return await r.json()}static async GetResource(e,t){let r=this._resourceCallbacks.get(e)??new H;r.AddListener(t),this._resourceCallbacks.set(e,r),t(await this.GetResourceNow(e))}static async FetchResources(){let{valid:e,token:t}=await this.GetToken();if(!e)return!1;let r=new URL("https://sbhs-random-data.profsmart.repl.co/resources");r.searchParams.append("token",JSON.stringify(t));let i=await fetch(r.toString());if(!i.ok)return this.ShowLoginNotification(),!1;let o=await i.json();return await(await caches.open("User Resources")).put("Token",new Response(JSON.stringify(o.token))),await this.SetResources(Object.keys(o.result).map(c=>({name:c,resource:JSON.stringify(o.result[c])}))),!0}};A._resourceCallbacks=new Map;var ue=window.ShadowRoot&&(window.ShadyCSS===void 0||window.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,$e=Symbol(),Me=new Map,ge=class{constructor(e,t){if(this._$cssResult$=!0,t!==$e)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e}get styleSheet(){let e=Me.get(this.cssText);return ue&&e===void 0&&(Me.set(this.cssText,e=new CSSStyleSheet),e.replaceSync(this.cssText)),e}toString(){return this.cssText}},Ne=s=>new ge(typeof s=="string"?s:s+"",$e),d=(s,...e)=>{let t=s.length===1?s[0]:e.reduce((r,i,o)=>r+(n=>{if(n._$cssResult$===!0)return n.cssText;if(typeof n=="number")return n;throw Error("Value passed to 'css' function must be a 'css' function result: "+n+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(i)+s[o+1],s[0]);return new ge(t,$e)},Ee=(s,e)=>{ue?s.adoptedStyleSheets=e.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet):e.forEach(t=>{let r=document.createElement("style"),i=window.litNonce;i!==void 0&&r.setAttribute("nonce",i),r.textContent=t.cssText,s.appendChild(r)})},fe=ue?s=>s:s=>s instanceof CSSStyleSheet?(e=>{let t="";for(let r of e.cssRules)t+=r.cssText;return Ne(t)})(s):s;var Ce,Ue=window.trustedTypes,It=Ue?Ue.emptyScript:"",He=window.reactiveElementPolyfillSupport,_e={toAttribute(s,e){switch(e){case Boolean:s=s?It:null;break;case Object:case Array:s=s==null?s:JSON.stringify(s)}return s},fromAttribute(s,e){let t=s;switch(e){case Boolean:t=s!==null;break;case Number:t=s===null?null:Number(s);break;case Object:case Array:try{t=JSON.parse(s)}catch{t=null}}return t}},Ie=(s,e)=>e!==s&&(e==e||s==s),Ae={attribute:!0,type:String,converter:_e,reflect:!1,hasChanged:Ie},I=class extends HTMLElement{constructor(){super(),this._$Et=new Map,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Ei=null,this.o()}static addInitializer(e){var t;(t=this.l)!==null&&t!==void 0||(this.l=[]),this.l.push(e)}static get observedAttributes(){this.finalize();let e=[];return this.elementProperties.forEach((t,r)=>{let i=this._$Eh(r,t);i!==void 0&&(this._$Eu.set(i,r),e.push(i))}),e}static createProperty(e,t=Ae){if(t.state&&(t.attribute=!1),this.finalize(),this.elementProperties.set(e,t),!t.noAccessor&&!this.prototype.hasOwnProperty(e)){let r=typeof e=="symbol"?Symbol():"__"+e,i=this.getPropertyDescriptor(e,r,t);i!==void 0&&Object.defineProperty(this.prototype,e,i)}}static getPropertyDescriptor(e,t,r){return{get(){return this[t]},set(i){let o=this[e];this[t]=i,this.requestUpdate(e,o,r)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)||Ae}static finalize(){if(this.hasOwnProperty("finalized"))return!1;this.finalized=!0;let e=Object.getPrototypeOf(this);if(e.finalize(),this.elementProperties=new Map(e.elementProperties),this._$Eu=new Map,this.hasOwnProperty("properties")){let t=this.properties,r=[...Object.getOwnPropertyNames(t),...Object.getOwnPropertySymbols(t)];for(let i of r)this.createProperty(i,t[i])}return this.elementStyles=this.finalizeStyles(this.styles),!0}static finalizeStyles(e){let t=[];if(Array.isArray(e)){let r=new Set(e.flat(1/0).reverse());for(let i of r)t.unshift(fe(i))}else e!==void 0&&t.push(fe(e));return t}static _$Eh(e,t){let r=t.attribute;return r===!1?void 0:typeof r=="string"?r:typeof e=="string"?e.toLowerCase():void 0}o(){var e;this._$Ep=new Promise(t=>this.enableUpdating=t),this._$AL=new Map,this._$Em(),this.requestUpdate(),(e=this.constructor.l)===null||e===void 0||e.forEach(t=>t(this))}addController(e){var t,r;((t=this._$Eg)!==null&&t!==void 0?t:this._$Eg=[]).push(e),this.renderRoot!==void 0&&this.isConnected&&((r=e.hostConnected)===null||r===void 0||r.call(e))}removeController(e){var t;(t=this._$Eg)===null||t===void 0||t.splice(this._$Eg.indexOf(e)>>>0,1)}_$Em(){this.constructor.elementProperties.forEach((e,t)=>{this.hasOwnProperty(t)&&(this._$Et.set(t,this[t]),delete this[t])})}createRenderRoot(){var e;let t=(e=this.shadowRoot)!==null&&e!==void 0?e:this.attachShadow(this.constructor.shadowRootOptions);return Ee(t,this.constructor.elementStyles),t}connectedCallback(){var e;this.renderRoot===void 0&&(this.renderRoot=this.createRenderRoot()),this.enableUpdating(!0),(e=this._$Eg)===null||e===void 0||e.forEach(t=>{var r;return(r=t.hostConnected)===null||r===void 0?void 0:r.call(t)})}enableUpdating(e){}disconnectedCallback(){var e;(e=this._$Eg)===null||e===void 0||e.forEach(t=>{var r;return(r=t.hostDisconnected)===null||r===void 0?void 0:r.call(t)})}attributeChangedCallback(e,t,r){this._$AK(e,r)}_$ES(e,t,r=Ae){var i,o;let n=this.constructor._$Eh(e,r);if(n!==void 0&&r.reflect===!0){let c=((o=(i=r.converter)===null||i===void 0?void 0:i.toAttribute)!==null&&o!==void 0?o:_e.toAttribute)(t,r.type);this._$Ei=e,c==null?this.removeAttribute(n):this.setAttribute(n,c),this._$Ei=null}}_$AK(e,t){var r,i,o;let n=this.constructor,c=n._$Eu.get(e);if(c!==void 0&&this._$Ei!==c){let h=n.getPropertyOptions(c),m=h.converter,R=(o=(i=(r=m)===null||r===void 0?void 0:r.fromAttribute)!==null&&i!==void 0?i:typeof m=="function"?m:null)!==null&&o!==void 0?o:_e.fromAttribute;this._$Ei=c,this[c]=R(t,h.type),this._$Ei=null}}requestUpdate(e,t,r){let i=!0;e!==void 0&&(((r=r||this.constructor.getPropertyOptions(e)).hasChanged||Ie)(this[e],t)?(this._$AL.has(e)||this._$AL.set(e,t),r.reflect===!0&&this._$Ei!==e&&(this._$E_===void 0&&(this._$E_=new Map),this._$E_.set(e,r))):i=!1),!this.isUpdatePending&&i&&(this._$Ep=this._$EC())}async _$EC(){this.isUpdatePending=!0;try{await this._$Ep}catch(t){Promise.reject(t)}let e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){var e;if(!this.isUpdatePending)return;this.hasUpdated,this._$Et&&(this._$Et.forEach((i,o)=>this[o]=i),this._$Et=void 0);let t=!1,r=this._$AL;try{t=this.shouldUpdate(r),t?(this.willUpdate(r),(e=this._$Eg)===null||e===void 0||e.forEach(i=>{var o;return(o=i.hostUpdate)===null||o===void 0?void 0:o.call(i)}),this.update(r)):this._$EU()}catch(i){throw t=!1,this._$EU(),i}t&&this._$AE(r)}willUpdate(e){}_$AE(e){var t;(t=this._$Eg)===null||t===void 0||t.forEach(r=>{var i;return(i=r.hostUpdated)===null||i===void 0?void 0:i.call(r)}),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$EU(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$Ep}shouldUpdate(e){return!0}update(e){this._$E_!==void 0&&(this._$E_.forEach((t,r)=>this._$ES(r,this[r],t)),this._$E_=void 0),this._$EU()}updated(e){}firstUpdated(e){}};I.finalized=!0,I.elementProperties=new Map,I.elementStyles=[],I.shadowRootOptions={mode:"open"},He==null||He({ReactiveElement:I}),((Ce=globalThis.reactiveElementVersions)!==null&&Ce!==void 0?Ce:globalThis.reactiveElementVersions=[]).push("1.0.2");var Se,V=globalThis.trustedTypes,De=V?V.createPolicy("lit-html",{createHTML:s=>s}):void 0,D=`lit$${(Math.random()+"").slice(9)}$`,Oe="?"+D,Dt=`<${Oe}>`,Z=document,oe=(s="")=>Z.createComment(s),ne=s=>s===null||typeof s!="object"&&typeof s!="function",ze=Array.isArray,Ot=s=>{var e;return ze(s)||typeof((e=s)===null||e===void 0?void 0:e[Symbol.iterator])=="function"},ae=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,je=/-->/g,qe=/>/g,q=/>|[ 	\n\r](?:([^\s"'>=/]+)([ 	\n\r]*=[ 	\n\r]*(?:[^ 	\n\r"'`<>=]|("|')|))|$)/g,Be=/'/g,Fe=/"/g,Ge=/^(?:script|style|textarea)$/i,Ve=s=>(e,...t)=>({_$litType$:s,strings:e,values:t}),p=Ve(1),W=Ve(2),N=Symbol.for("lit-noChange"),y=Symbol.for("lit-nothing"),Ze=new WeakMap,We=(s,e,t)=>{var r,i;let o=(r=t==null?void 0:t.renderBefore)!==null&&r!==void 0?r:e,n=o._$litPart$;if(n===void 0){let c=(i=t==null?void 0:t.renderBefore)!==null&&i!==void 0?i:null;o._$litPart$=n=new X(e.insertBefore(oe(),c),c,void 0,t??{})}return n._$AI(s),n},J=Z.createTreeWalker(Z,129,null,!1),zt=(s,e)=>{let t=s.length-1,r=[],i,o=e===2?"<svg>":"",n=ae;for(let h=0;h<t;h++){let m=s[h],R,b,$=-1,P=0;for(;P<m.length&&(n.lastIndex=P,b=n.exec(m),b!==null);)P=n.lastIndex,n===ae?b[1]==="!--"?n=je:b[1]!==void 0?n=qe:b[2]!==void 0?(Ge.test(b[2])&&(i=RegExp("</"+b[2],"g")),n=q):b[3]!==void 0&&(n=q):n===q?b[0]===">"?(n=i??ae,$=-1):b[1]===void 0?$=-2:($=n.lastIndex-b[2].length,R=b[1],n=b[3]===void 0?q:b[3]==='"'?Fe:Be):n===Fe||n===Be?n=q:n===je||n===qe?n=ae:(n=q,i=void 0);let he=n===q&&s[h+1].startsWith("/>")?" ":"";o+=n===ae?m+Dt:$>=0?(r.push(R),m.slice(0,$)+"$lit$"+m.slice($)+D+he):m+D+($===-2?(r.push(void 0),h):he)}let c=o+(s[t]||"<?>")+(e===2?"</svg>":"");return[De!==void 0?De.createHTML(c):c,r]},Y=class{constructor({strings:e,_$litType$:t},r){let i;this.parts=[];let o=0,n=0,c=e.length-1,h=this.parts,[m,R]=zt(e,t);if(this.el=Y.createElement(m,r),J.currentNode=this.el.content,t===2){let b=this.el.content,$=b.firstChild;$.remove(),b.append(...$.childNodes)}for(;(i=J.nextNode())!==null&&h.length<c;){if(i.nodeType===1){if(i.hasAttributes()){let b=[];for(let $ of i.getAttributeNames())if($.endsWith("$lit$")||$.startsWith(D)){let P=R[n++];if(b.push($),P!==void 0){let he=i.getAttribute(P.toLowerCase()+"$lit$").split(D),me=/([.?@])?(.*)/.exec(P);h.push({type:1,index:o,name:me[2],strings:he,ctor:me[1]==="."?Ye:me[1]==="?"?Ke:me[1]==="@"?Xe:le})}else h.push({type:6,index:o})}for(let $ of b)i.removeAttribute($)}if(Ge.test(i.tagName)){let b=i.textContent.split(D),$=b.length-1;if($>0){i.textContent=V?V.emptyScript:"";for(let P=0;P<$;P++)i.append(b[P],oe()),J.nextNode(),h.push({type:2,index:++o});i.append(b[$],oe())}}}else if(i.nodeType===8)if(i.data===Oe)h.push({type:2,index:o});else{let b=-1;for(;(b=i.data.indexOf(D,b+1))!==-1;)h.push({type:7,index:o}),b+=D.length-1}o++}}static createElement(e,t){let r=Z.createElement("template");return r.innerHTML=e,r}};function K(s,e,t=s,r){var i,o,n,c;if(e===N)return e;let h=r!==void 0?(i=t._$Cl)===null||i===void 0?void 0:i[r]:t._$Cu,m=ne(e)?void 0:e._$litDirective$;return(h==null?void 0:h.constructor)!==m&&((o=h==null?void 0:h._$AO)===null||o===void 0||o.call(h,!1),m===void 0?h=void 0:(h=new m(s),h._$AT(s,t,r)),r!==void 0?((n=(c=t)._$Cl)!==null&&n!==void 0?n:c._$Cl=[])[r]=h:t._$Cu=h),h!==void 0&&(e=K(s,h._$AS(s,e.values),h,r)),e}var Je=class{constructor(e,t){this.v=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}p(e){var t;let{el:{content:r},parts:i}=this._$AD,o=((t=e==null?void 0:e.creationScope)!==null&&t!==void 0?t:Z).importNode(r,!0);J.currentNode=o;let n=J.nextNode(),c=0,h=0,m=i[0];for(;m!==void 0;){if(c===m.index){let R;m.type===2?R=new X(n,n.nextSibling,this,e):m.type===1?R=new m.ctor(n,m.name,m.strings,this,e):m.type===6&&(R=new Qe(n,this,e)),this.v.push(R),m=i[++h]}c!==(m==null?void 0:m.index)&&(n=J.nextNode(),c++)}return o}m(e){let t=0;for(let r of this.v)r!==void 0&&(r.strings!==void 0?(r._$AI(e,r,t),t+=r.strings.length-2):r._$AI(e[t])),t++}},X=class{constructor(e,t,r,i){var o;this.type=2,this._$AH=y,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=r,this.options=i,this._$Cg=(o=i==null?void 0:i.isConnected)===null||o===void 0||o}get _$AU(){var e,t;return(t=(e=this._$AM)===null||e===void 0?void 0:e._$AU)!==null&&t!==void 0?t:this._$Cg}get parentNode(){let e=this._$AA.parentNode,t=this._$AM;return t!==void 0&&e.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=K(this,e,t),ne(e)?e===y||e==null||e===""?(this._$AH!==y&&this._$AR(),this._$AH=y):e!==this._$AH&&e!==N&&this.$(e):e._$litType$!==void 0?this.T(e):e.nodeType!==void 0?this.S(e):Ot(e)?this.M(e):this.$(e)}A(e,t=this._$AB){return this._$AA.parentNode.insertBefore(e,t)}S(e){this._$AH!==e&&(this._$AR(),this._$AH=this.A(e))}$(e){this._$AH!==y&&ne(this._$AH)?this._$AA.nextSibling.data=e:this.S(Z.createTextNode(e)),this._$AH=e}T(e){var t;let{values:r,_$litType$:i}=e,o=typeof i=="number"?this._$AC(e):(i.el===void 0&&(i.el=Y.createElement(i.h,this.options)),i);if(((t=this._$AH)===null||t===void 0?void 0:t._$AD)===o)this._$AH.m(r);else{let n=new Je(o,this),c=n.p(this.options);n.m(r),this.S(c),this._$AH=n}}_$AC(e){let t=Ze.get(e.strings);return t===void 0&&Ze.set(e.strings,t=new Y(e)),t}M(e){ze(this._$AH)||(this._$AH=[],this._$AR());let t=this._$AH,r,i=0;for(let o of e)i===t.length?t.push(r=new X(this.A(oe()),this.A(oe()),this,this.options)):r=t[i],r._$AI(o),i++;i<t.length&&(this._$AR(r&&r._$AB.nextSibling,i),t.length=i)}_$AR(e=this._$AA.nextSibling,t){var r;for((r=this._$AP)===null||r===void 0||r.call(this,!1,!0,t);e&&e!==this._$AB;){let i=e.nextSibling;e.remove(),e=i}}setConnected(e){var t;this._$AM===void 0&&(this._$Cg=e,(t=this._$AP)===null||t===void 0||t.call(this,e))}},le=class{constructor(e,t,r,i,o){this.type=1,this._$AH=y,this._$AN=void 0,this.element=e,this.name=t,this._$AM=i,this.options=o,r.length>2||r[0]!==""||r[1]!==""?(this._$AH=Array(r.length-1).fill(new String),this.strings=r):this._$AH=y}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(e,t=this,r,i){let o=this.strings,n=!1;if(o===void 0)e=K(this,e,t,0),n=!ne(e)||e!==this._$AH&&e!==N,n&&(this._$AH=e);else{let c=e,h,m;for(e=o[0],h=0;h<o.length-1;h++)m=K(this,c[r+h],t,h),m===N&&(m=this._$AH[h]),n||(n=!ne(m)||m!==this._$AH[h]),m===y?e=y:e!==y&&(e+=(m??"")+o[h+1]),this._$AH[h]=m}n&&!i&&this.k(e)}k(e){e===y?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}},Ye=class extends le{constructor(){super(...arguments),this.type=3}k(e){this.element[this.name]=e===y?void 0:e}},jt=V?V.emptyScript:"",Ke=class extends le{constructor(){super(...arguments),this.type=4}k(e){e&&e!==y?this.element.setAttribute(this.name,jt):this.element.removeAttribute(this.name)}},Xe=class extends le{constructor(e,t,r,i,o){super(e,t,r,i,o),this.type=5}_$AI(e,t=this){var r;if((e=(r=K(this,e,t,0))!==null&&r!==void 0?r:y)===N)return;let i=this._$AH,o=e===y&&i!==y||e.capture!==i.capture||e.once!==i.once||e.passive!==i.passive,n=e!==y&&(i===y||o);o&&this.element.removeEventListener(this.name,this,i),n&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){var t,r;typeof this._$AH=="function"?this._$AH.call((r=(t=this.options)===null||t===void 0?void 0:t.host)!==null&&r!==void 0?r:this.element,e):this._$AH.handleEvent(e)}},Qe=class{constructor(e,t,r){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=r}get _$AU(){return this._$AM._$AU}_$AI(e){K(this,e)}};var et=window.litHtmlPolyfillSupport;et==null||et(Y,X),((Se=globalThis.litHtmlVersions)!==null&&Se!==void 0?Se:globalThis.litHtmlVersions=[]).push("2.0.2");var Te,Re;var v=class extends I{constructor(){super(...arguments),this.renderOptions={host:this},this._$Dt=void 0}createRenderRoot(){var e,t;let r=super.createRenderRoot();return(e=(t=this.renderOptions).renderBefore)!==null&&e!==void 0||(t.renderBefore=r.firstChild),r}update(e){let t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Dt=We(t,this.renderRoot,this.renderOptions)}connectedCallback(){var e;super.connectedCallback(),(e=this._$Dt)===null||e===void 0||e.setConnected(!0)}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this._$Dt)===null||e===void 0||e.setConnected(!1)}render(){return N}};v.finalized=!0,v._$litElement$=!0,(Te=globalThis.litElementHydrateSupport)===null||Te===void 0||Te.call(globalThis,{LitElement:v});var tt=globalThis.litElementPolyfillSupport;tt==null||tt({LitElement:v});((Re=globalThis.litElementVersions)!==null&&Re!==void 0?Re:globalThis.litElementVersions=[]).push("3.0.2");var f=s=>e=>typeof e=="function"?((t,r)=>(window.customElements.define(t,r),r))(s,e):((t,r)=>{let{kind:i,elements:o}=r;return{kind:i,elements:o,finisher(n){window.customElements.define(t,n)}}})(s,e);var qt=(s,e)=>e.kind==="method"&&e.descriptor&&!("value"in e.descriptor)?{...e,finisher(t){t.createProperty(e.key,s)}}:{kind:"field",key:Symbol(),placement:"own",descriptor:{},originalKey:e.key,initializer(){typeof e.initializer=="function"&&(this[e.key]=e.initializer.call(this))},finisher(t){t.createProperty(e.key,s)}};function g(s){return(e,t)=>t!==void 0?((r,i,o)=>{i.constructor.createProperty(o,r)})(s,e,t):qt(s,e)}function E(s){return g({...s,state:!0})}var Q=({finisher:s,descriptor:e})=>(t,r)=>{var i;if(r===void 0){let o=(i=t.originalKey)!==null&&i!==void 0?i:t.key,n=e!=null?{kind:"method",placement:"prototype",key:o,descriptor:e(t.key)}:{...t,key:o};return s!=null&&(n.finisher=function(c){s(c,o)}),n}{let o=t.constructor;e!==void 0&&Object.defineProperty(t,r,e(r)),s==null||s(o,r)}};function _(s,e){return Q({descriptor:t=>{let r={get(){var i,o;return(o=(i=this.renderRoot)===null||i===void 0?void 0:i.querySelector(s))!==null&&o!==void 0?o:null},enumerable:!0,configurable:!0};if(e){let i=typeof t=="symbol"?Symbol():"__"+t;r.get=function(){var o,n;return this[i]===void 0&&(this[i]=(n=(o=this.renderRoot)===null||o===void 0?void 0:o.querySelector(s))!==null&&n!==void 0?n:null),this[i]}}return r}})}var S=d`:where(img, svg) {
...
::slotted(img) {
    ...
    cursor: pointer;
        ...
        ${this.editing?p`<img id="handle" src="images/drag.svg" draggable="false">`:y}
        `}};O.styles=[x,S,rt],a([g({type:String})],O.prototype,"pageName",2),a([g({type:Boolean})],O.prototype,"extension",2),a([g({type:String})],O.prototype,"title",2),a([g({type:Boolean})],O.prototype,"editing",2),O=a([f("nav-item")],O);var it=d`:host {
    flex-shrink: 0;
...
}`;var w=class extends v{constructor(){super(...arguments);this.editing=!1;this.pages=[];this.icons=[];this.order=[];this.draggedNavItemIndex=0;this.GetNavItem=((e,t)=>{let r,i,o,n=!1;return e<w.defaultPages.length?{page:r,title:i,icon:o}=w.defaultPages[e]:(r=this.pages[e-w.defaultPages.length],i=this.pages[e-w.defaultPages.length],o=this.icons[e-w.defaultPages.length],n=!0),p`
...
.info {
    font-size: 0.7rem;
}`;var L=class extends v{render(){return p`
        <details>
            <summary>
                <h3>${this.title}</h3>
        ...
        `}};L.styles=[x,ut],a([g()],L.prototype,"title",2),a([g()],L.prototype,"author",2),a([g()],L.prototype,"years",2),a([g({type:Boolean})],L.prototype,"meeting",2),a([g()],L.prototype,"meetingTime",2),a([g()],L.prototype,"content",2),a([g({type:Number})],L.prototype,"weight",2),L=a([f("announcement-post")],L);var be=d`:where(input[type=search]) {
    border: none;
...
announcement-post {
    margin-bottom: 1.2rem;
}`;var B=class extends M{constructor(){super();this.yearFilter="all";this.searchFilter="";this.AddResource("announcements","announcements")}renderPage(){let e=this.yearFilter=="all"?this.announcements.notices:this.announcements.notices.filter(t=>t.years.includes(this.yearFilter));return e=this.searchFilter==""?e:e.filter(t=>t.title.toLowerCase().includes(this.searchFilter.toLowerCase())||t.content.toLowerCase().includes(this.searchFilter.toLowerCase())),p`
        <div class="header">
        ...
        `)}</div>
        `}};B.styles=[x,S,be,gt,T,ee,ft],a([E()],B.prototype,"announcements",2),a([E()],B.prototype,"yearFilter",2),a([E()],B.prototype,"searchFilter",2),B=a([f("school-announcements")],B);function U(s,e,t){let r=s;for(let i=0;i<e.length;i++){if(r==null||typeof r!==e[i])return;i<t.length&&(r=r[t[i]])}return r}var vt=d`:host {
    position: relative;
    display: block;
}
...
.background {
    ...
    clip-path: polygon(0 0, 100% 100%, 0 100%);
        ...
        `}};te.styles=[S,vt],a([_("slot")],te.prototype,"info",2),a([_(".background")],te.prototype,"background",2),te=a([f("info-popup")],te);var yt=d`:host {
    position: relative;
...
info-popup {
    ...
    z-index: 2;
        ...
        `}};F.styles=[x,S,T,ee,yt],a([_("#barcodeDisplay")],F.prototype,"barcode",2),a([_("#point1")],F.prototype,"point1",2),a([_("#point2")],F.prototype,"point2",2),F=a([f("student-barcode")],F);var ye=(r=>(r.NO_COVER="nocover",r.REPLACEMENT="replacement",r.NO_VARIATION="novariation",r))(ye||{});var xt=d`:host {
    display: flex;
    justify-content: space-between;
...
p {
    color: var(--text3);
}`;var re=class extends v{render(){return p`
            <p>${this.title}</p>
            <p>${this.time}</p>
...
.info {
    font-size: 0.6rem;
}`;var z=class extends v{render(){return p`
            <div>
                <p>${this.title}</p>
...
.periods {
    ...
    width: 80%;
}`;var de=class extends M{constructor(){super();this.AddResource("dailytimetable","dailyTimetable")}GetBell(e){return p`<daily-timetable-bell title="${e.bellDisplay}" time="${e.time}"></daily-timetable-bell>`}GetPeriodTitle(e,t){return this.dailyTimetable.timetable.subjects[`${e}${t}`].title.split(" ").filter(i=>isNaN(parseFloat(i))&&i.length>1||i=="&").join(" ")}GetPeriod(e,t,r,i){return p`
        ...
        `}renderPage(){let e=this.dailyTimetable.bells,t=this.dailyTimetable.timetable.timetable.periods,r=Array.isArray(this.dailyTimetable.roomVariations)?{}:this.dailyTimetable.roomVariations,i=Array.isArray(this.dailyTimetable.classVariations)?{}:this.dailyTimetable.classVariations;return p`
        ...
        `}};de.styles=[x,T,xe,kt],a([E()],de.prototype,"dailyTimetable",2),de=a([f("daily-timetable")],de);var $t=d`:host {
    overflow: hidden;
    display: flex;
    align-items: center;
    justify-content: center;
...
iframe {
    ...
    height: inherit;
    border: none;
}`;var G=class extends v{constructor(){super(...arguments);this.src=""}StopLoading(){this.loader.remove(),this.frame.removeAttribute("style")}render(){return p`
        ...
        `}};G.styles=Ct,a([g({type:String})],G.prototype,"src",2),a([_("iframe",!0)],G.prototype,"frame",2),a([_("loading-indicator",!0)],G.prototype,"loader",2),G=a([f("extension-page")],G);var ke=d`a.button {
    text-decoration: none;
    cursor: default;
}
...
.content {
    ...
    flex: 1;
}`;var j=class extends v{async Install(){await ot(this.title),document.getElementById("pages").requestUpdate()}async Uninstall(){await nt(this.title),document.getElementById("pages").requestUpdate()}render(){return p`
        <img src="${this.img}">
...
.content:empty::after {
    ...
    font-size: 1.4rem;
}`;var ce=class extends v{constructor(){super();this.fetchingExtensions=!0;this.extensions=new Map;at(e=>{this.fetchingExtensions=!1,this.extensions=e})}render(){let e=k.installedExtensions,t=[];for(var r of e.keys())t.push(r);return p`
        <div class="header">
            <input type="search" placeholder="Search..." @input="${i=>this.searchFilter=i.target.value}">
            <input type="checkbox">
        </div>

        ${this.fetchingExtensions?y:p`
        <!--The ugliest code ever written, but the div tags for .content need to be where they are, or the :empty selector won't work-->
        <div class="content">${[...this.extensions.keys()].map(i=>p`
        ...
        `)}</div>
        `}
        `}};ce.styles=[x,be,T,ee,At],a([E()],ce.prototype,"extensions",2),ce=a([f("extensions-marketplace")],ce);var St=d`:host {
    position: relative;
    display: flex;
    align-items: center;
    justify-content: space-between;
...
svg {
    width: inherit;
    height: inherit;
}`;var Tt=W`<svg width="220" height="220" viewBox="0 0 220 220" xmlns="http://www.w3.org/2000/svg"><g fill="none" stroke="#323232" stroke-width="10" stroke-linecap="round"><path d="m5 5 210 210M215 5 5 215"/></g></svg>`;var pe=class extends v{constructor(){super(...arguments);this.Close=this.remove.bind(this)}render(){return p`
        <slot></slot>
        ${this.loader?p`
        ...
        `}};pe.styles=[S,St],a([g({type:Boolean})],pe.prototype,"loader",2),pe=a([f("inline-notification")],pe);var Rt=d`:where(input[type=range]) {
    appearance: none;
    width: 7rem;
...
info-popup {
    ...
    z-index: 2;
        ...
        `}};ie.styles=[x,S,ke,Rt,xe,T,Pt],a([_("#hue",!0)],ie.prototype,"hueInput",2),a([E()],ie.prototype,"version",2),ie=a([f("user-settings")],ie);var Lt=d`:host {
    position: relative;
    display: flex;
    align-items: center;
    justify-content: center;
...
}`;var se=class extends M{set dailyTimetable(e){let t=U(e,["object","object","object","string"],["timetable","timetable","dayname"]);t!==void 0&&(this._day=t.slice(0,3).toUpperCase()+" "+t.slice(-1).toUpperCase())}constructor(){super();this.AddResource("timetable","timetable"),this.AddResource("dailytimetable","dailyTimetable"),document.addEventListener("pointerover",this.ClearHighlight)}SetHighlight(e){C.Highlight(e.target.name),e.stopPropagation()}ClearHighlight(e){C.Highlight(void 0),e.stopPropagation()}CreateTable(e){let t=[],r=[];for(let i of e){t.push(U(i,["object","string"],["dayname"])??"");let o=U(i,["object","object"],["periods"])??{},n=Object.keys(o);for(let c=0;c<n.length;c++)c>=r.length?r.push([o[n[c]]]):r[c].push(o[n[c]])}return p`
        <table>
            <thead>
                <tr>
                    <th></th>
                    ${t.map(i=>{let o=i.split(" "),n=`${o.shift()?.substring(0,3).toUpperCase()??"???"} ${o.map(c=>c.toUpperCase()).join(" ")}`;return p`
            ...
            <tbody>
                ${r.map(i=>p`
                <tr>
                    ${i.map(o=>{let n=U(o,["object","string"],["title"])??"";return p`
                        <td>
                            <timetable-period name="${n}" room="${U(o,["object","string"],["room"])??"???"}"></timetable-period>
                        </td>
                        `})}
                </tr>
                `)}
