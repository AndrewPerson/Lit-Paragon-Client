...
::slotted(img) {
    ...
    cursor: pointer;
        ...
        `}};z.styles=[x,T,tt],a([u({type:String})],z.prototype,"pageName",2),a([u({type:Boolean})],z.prototype,"extension",2),a([u({type:String})],z.prototype,"title",2),a([u({type:Boolean})],z.prototype,"editing",2),z=a([f("nav-item")],z);var it=p`:host {
    flex-shrink: 0;
...
}`;var w=class extends v{constructor(){super(...arguments);this.editing=!1;this.pages=[];this.icons=[];this.order=[];this.draggedNavItemIndex=0;this.GetNavItem=((e,t)=>{let i,r,o,n=!1;return e<w.defaultPages.length?{page:i,title:r,icon:o}=w.defaultPages[e]:(i=this.pages[e-w.defaultPages.length],r=this.pages[e-w.defaultPages.length],o=this.icons[e-w.defaultPages.length],n=!0),m`
...
.info {
    font-size: 0.7rem;
}`;var M=class extends v{render(){return m`
        <details>
            <summary>
                <h3>${this.title}</h3>
        ...
        `}};M.styles=[x,mt],a([u()],M.prototype,"title",2),a([u()],M.prototype,"author",2),a([u()],M.prototype,"years",2),a([u({type:Boolean})],M.prototype,"meeting",2),a([u()],M.prototype,"meetingDate",2),a([u()],M.prototype,"meetingTime",2),a([u()],M.prototype,"content",2),a([u({type:Number})],M.prototype,"weight",2),M=a([f("announcement-post")],M);var be=p`:where(input[type=search]) {
    border: none;
...
announcement-post {
    margin-bottom: 1.2rem;
        ...
        <div class="content">${t.map(i=>{let r=i.isMeeting==1,o=i.meetingDate??"";return new Date().toISOString().split("T")[0]==o&&(o=""),m`
            ...
            `})}</div>
        `}};F.styles=[x,T,be,ut,R,Q,gt],a([_()],F.prototype,"announcements",2),a([_()],F.prototype,"yearFilter",2),a([_()],F.prototype,"searchFilter",2),F=a([f("school-announcements")],F);var ft=p`:host {
    position: relative;
    display: block;
}
...
.background {
    ...
    clip-path: polygon(0 0, 100% 100%, 0 100%);
        ...
        `}};ee.styles=[T,ft],a([A("slot")],ee.prototype,"info",2),a([A(".background")],ee.prototype,"background",2),ee=a([f("info-popup")],ee);var bt=p`:host {
    position: relative;
...
#save > svg {
    ...
    height: inherit;
        ...
        `}};j.styles=[x,T,R,Q,bt],a([A("#barcodeDisplay")],j.prototype,"barcode",2),a([A("#point1")],j.prototype,"point1",2),a([A("#point2")],j.prototype,"point2",2),a([A("#save")],j.prototype,"saveLink",2),j=a([f("student-barcode")],j);var xt=p`:host {
    display: flex;
    justify-content: space-between;
...
.changed {
    color: var(--text2);
}`;var te=class extends v{render(){return m`
            <p>${this.title}</p>
            <p>${this.time}</p>
        `}};te.styles=[x,xt],a([u()],te.prototype,"title",2),a([u()],te.prototype,"time",2),te=a([f("daily-timetable-bell")],te);var wt=p`:host {
    display: flex;
    align-items: center;
    justify-content: space-between;
...
.changed {
    color: var(--text2);
}`;var N=class extends v{render(){return m`
            <div>
                <p>${this.title}</p>
            ...
            <p>${this.time}</p>
        `}};N.styles=[x,wt],a([u()],N.prototype,"title",2),a([u()],N.prototype,"time",2),a([u()],N.prototype,"teacher",2),a([u({type:Boolean})],N.prototype,"teacherChanged",2),a([u()],N.prototype,"room",2),a([u({type:Boolean})],N.prototype,"roomChanged",2),N=a([f("daily-timetable-period")],N);var de=(i=>(i.NO_COVER="nocover",i.REPLACEMENT="replacement",i.NO_VARIATION="novariation",i))(de||{});var ye=p`:host, main {
    padding: 0.8rem;
...
.periods {
    ...
    width: 80%;
        ...
        `}renderPage(){let e=this.NextBell();e===void 0&&this.UpdateData();let t=this._dailyTimetable?.timetable?.timetable?.periods?.[e?.bell??""],i=e?.bellDisplay??"Nothing";t!=null&&"year"in t&&(i=this.GetPeriodTitle(t.year??"?",t.title??"???"));let r={time:"Never",preposition:"in"};e!==void 0&&(r=this.TimeDisplay(e));let o=this._dailyTimetable.bells??[],n=this._dailyTimetable.timetable?.timetable?.periods??{},c=(Array.isArray(this._dailyTimetable.roomVariations)?{}:this._dailyTimetable.roomVariations)??{},d=(Array.isArray(this._dailyTimetable.classVariations)?{}:this._dailyTimetable.classVariations)??{};return m`
            ...
            <div class="periods">
                ${o.map(h=>{if(h.period!==void 0&&h.period!==null&&h.period in n){let k=n[h.period];return k!=null&&"fullTeacher"in k&&"year"in k?this.GetPeriod(k,h,d[h.period],c[h.period]):this.GetBell(h)}else return this.GetBell(h)})}
            </div>
        `}};ie.styles=[x,R,ye,$t],ie.updatingData=!1,a([_()],ie.prototype,"_dailyTimetable",2),ie=a([f("daily-timetable")],ie);var Et=p`:host {
    overflow: hidden;
    display: flex;
    align-items: center;
    justify-content: center;
...
iframe {
    ...
    height: inherit;
    border: none;
}`;var G=class extends v{constructor(){super(...arguments);this.src=""}StopLoading(){this.loader.remove(),this.frame.removeAttribute("style")}render(){return m`
        ...
        `}};G.styles=Ct,a([u({type:String})],G.prototype,"src",2),a([A("iframe",!0)],G.prototype,"frame",2),a([A("loading-indicator",!0)],G.prototype,"loader",2),G=a([f("extension-page")],G);var we=p`a.button {
    text-decoration: none;
    cursor: default;
}
...
.content {
    ...
    flex: 1;
}`;var B=class extends v{async Install(){await st(this.title),document.getElementById("pages").requestUpdate()}async Uninstall(){await ot(this.title),document.getElementById("pages").requestUpdate()}render(){return m`
        <img src="${this.img}">
        ...
        `}};B.styles=[x,we,_t],a([u()],B.prototype,"title",2),a([u()],B.prototype,"img",2),a([u()],B.prototype,"description",2),a([u({type:Boolean})],B.prototype,"installed",2),B=a([f("extension-display")],B);var At=p`:host {
    display: flex;
    flex-direction: column;
    gap: 1.2rem;
...
.content:empty::after {
    ...
    font-size: 1.4rem;
}`;var ce=class extends v{constructor(){super();this.fetchingExtensions=!0;this.extensions=new Map;nt(e=>{this.fetchingExtensions=!1,this.extensions=e})}render(){let e=$.installedExtensions,t=[];for(var i of e.keys())t.push(i);return m`
        <div class="header">
        ...
        `)}</div>
        `}
        `}};ce.styles=[x,be,R,Q,At],a([_()],ce.prototype,"extensions",2),ce=a([f("extensions-marketplace")],ce);var St=p`:host {
    position: relative;
    display: flex;
    align-items: center;
    justify-content: space-between;
...
svg {
    width: inherit;
    height: inherit;
}`;var Tt=O`<svg width="220" height="220" viewBox="0 0 220 220" xmlns="http://www.w3.org/2000/svg"><g fill="none" stroke="#323232" stroke-width="10" stroke-linecap="round"><path d="m5 5 210 210M215 5 5 215"/></g></svg>`;var he=class extends v{constructor(){super(...arguments);this.Close=this.remove.bind(this)}render(){return m`
        <slot></slot>
        ${this.loader?m`
        ...
        `}};he.styles=[T,St],a([u({type:Boolean})],he.prototype,"loader",2),he=a([f("inline-notification")],he);var Mt=p`:where(input[type=range]) {
    appearance: none;
    width: 7rem;
...
info-popup {
    ...
    z-index: 2;
        ...
        `}};re.styles=[x,T,we,Mt,ye,R,Rt],a([A("#hue",!0)],re.prototype,"hueInput",2),a([_()],re.prototype,"version",2),re=a([f("user-settings")],re);var Lt=p`:host {
    position: relative;
    display: flex;
    align-items: center;
    justify-content: center;
...
}`;var S=class extends v{static Highlight(e){if(this.highlighted!=e){this.highlighted=e;for(let t of this.instances)t.requestUpdate()}}constructor(){super();S.instances.push(this)}Highlight(){S.Highlight(this.name),this.classList.add("highlighted")}Unhighlight(){S.Highlight(void 0),this.classList.remove("highlighted")}firstUpdated(){this.room!==void 0&&this.room!==null&&(this.tabIndex=0)}render(){let e=S.highlighted==this.name;return this.classList.toggle("highlighted",e),e||this.blur(),m`
        <p>${this.name}</p>
        <p id="popup"
           style="${e?"":"display: none"}">
            ${this.room}
        </p>
        `}};S.styles=[x,Lt],S.instances=[],a([u()],S.prototype,"name",2),a([u()],S.prototype,"room",2),S=a([f("timetable-period")],S);var Pt=p`:host {
    margin: auto;
    padding: 1.6rem;
    max-width: 92%;
    width: 25.2rem;
