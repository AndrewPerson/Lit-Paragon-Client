var Ht=Object.defineProperty;var It=Object.getOwnPropertyDescriptor;var a=(s,e,t,i)=>{for(var r=i>1?void 0:i?It(e,t):e,o=s.length-1,n;o>=0;o--)(n=s[o])&&(r=(i?n(e,t,r):n(r))||r);return i&&r&&Ht(e,t,r),r};var H=class{constructor(){this._callbacks=[]}AddListener(e){this._callbacks.push(e)}Invoke(e){for(let t of this._callbacks)t(e)}};var E=class{static ShowLoginNotification(){let e=document.createElement("p");e.innerHTML="You need to <a>login</a> to see the latest information.",g.ShowNotification(e)}static ShowResourceNotification(){return g.ShowNotification("Updating resources...",!0)}static async GetToken(){let t=await(await caches.open("User Resources")).match("Token");if(!t)return location.href=`${location.origin}/login`,{valid:!1,token:null};let i=await t.json();return new Date>i.termination?(this.ShowLoginNotification(),{valid:!1,token:null}):{valid:!0,token:i}}static async SetResources(e){let t=await caches.open("User Resources"),i=e.map(r=>{let o=r.name,n=r.resource;return t.put(o,new Response(n)).then(()=>this._resourceCallbacks.get(o)?.Invoke(JSON.parse(n)))});await Promise.all(i)}static async SetResource(e,t){await(await caches.open("User Resources")).put(e,new Response(t)),this._resourceCallbacks.get(e)?.Invoke(JSON.parse(t))}static async GetResourceNow(e){let i=await(await caches.open("User Resources")).match(e);if(i)return await i.json()}static async GetResource(e,t){let i=this._resourceCallbacks.get(e)??new H;i.AddListener(t),this._resourceCallbacks.set(e,i),t(await this.GetResourceNow(e))}static async FetchResources(){if(this._fetching)return new Promise(d=>this._fetchCallbacks.AddListener(d));this._fetching=!0;let{valid:e,token:t}=await this.GetToken();if(!e)return!1;let i=this.ShowResourceNotification(),r=new URL("https://sbhs-random-data.profsmart.repl.co/resources");r.searchParams.append("token",JSON.stringify(t));let o=await fetch(r.toString());if(!o.ok)return i.Close(),this.ShowLoginNotification(),this._fetchCallbacks.Invoke(!1),this._fetching=!1,!1;let n=await o.json();return await(await caches.open("User Resources")).put("Token",new Response(JSON.stringify(n.token))),await this.SetResources(Object.keys(n.result).map(d=>({name:d,resource:JSON.stringify(n.result[d])}))),i.Close(),this._fetchCallbacks.Invoke(!0),this._fetching=!1,!0}};E._resourceCallbacks=new Map,E._fetchCallbacks=new H,E._fetching=!1;var ue=window.ShadowRoot&&(window.ShadyCSS===void 0||window.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,$e=Symbol(),Pe=new Map,ge=class{constructor(e,t){if(this._$cssResult$=!0,t!==$e)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e}get styleSheet(){let e=Pe.get(this.cssText);return ue&&e===void 0&&(Pe.set(this.cssText,e=new CSSStyleSheet),e.replaceSync(this.cssText)),e}toString(){return this.cssText}},Le=s=>new ge(typeof s=="string"?s:s+"",$e),h=(s,...e)=>{let t=s.length===1?s[0]:e.reduce((i,r,o)=>i+(n=>{if(n._$cssResult$===!0)return n.cssText;if(typeof n=="number")return n;throw Error("Value passed to 'css' function must be a 'css' function result: "+n+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(r)+s[o+1],s[0]);return new ge(t,$e)},ke=(s,e)=>{ue?s.adoptedStyleSheets=e.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet):e.forEach(t=>{let i=document.createElement("style"),r=window.litNonce;r!==void 0&&i.setAttribute("nonce",r),i.textContent=t.cssText,s.appendChild(i)})},fe=ue?s=>s:s=>s instanceof CSSStyleSheet?(e=>{let t="";for(let i of e.cssRules)t+=i.cssText;return Le(t)})(s):s;var Ee,Ne=window.trustedTypes,Dt=Ne?Ne.emptyScript:"",He=window.reactiveElementPolyfillSupport,_e={toAttribute(s,e){switch(e){case Boolean:s=s?Dt:null;break;case Object:case Array:s=s==null?s:JSON.stringify(s)}return s},fromAttribute(s,e){let t=s;switch(e){case Boolean:t=s!==null;break;case Number:t=s===null?null:Number(s);break;case Object:case Array:try{t=JSON.parse(s)}catch{t=null}}return t}},Ie=(s,e)=>e!==s&&(e==e||s==s),Ce={attribute:!0,type:String,converter:_e,reflect:!1,hasChanged:Ie},D=class extends HTMLElement{constructor(){super(),this._$Et=new Map,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Ei=null,this.o()}static addInitializer(e){var t;(t=this.l)!==null&&t!==void 0||(this.l=[]),this.l.push(e)}static get observedAttributes(){this.finalize();let e=[];return this.elementProperties.forEach((t,i)=>{let r=this._$Eh(i,t);r!==void 0&&(this._$Eu.set(r,i),e.push(r))}),e}static createProperty(e,t=Ce){if(t.state&&(t.attribute=!1),this.finalize(),this.elementProperties.set(e,t),!t.noAccessor&&!this.prototype.hasOwnProperty(e)){let i=typeof e=="symbol"?Symbol():"__"+e,r=this.getPropertyDescriptor(e,i,t);r!==void 0&&Object.defineProperty(this.prototype,e,r)}}static getPropertyDescriptor(e,t,i){return{get(){return this[t]},set(r){let o=this[e];this[t]=r,this.requestUpdate(e,o,i)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)||Ce}static finalize(){if(this.hasOwnProperty("finalized"))return!1;this.finalized=!0;let e=Object.getPrototypeOf(this);if(e.finalize(),this.elementProperties=new Map(e.elementProperties),this._$Eu=new Map,this.hasOwnProperty("properties")){let t=this.properties,i=[...Object.getOwnPropertyNames(t),...Object.getOwnPropertySymbols(t)];for(let r of i)this.createProperty(r,t[r])}return this.elementStyles=this.finalizeStyles(this.styles),!0}static finalizeStyles(e){let t=[];if(Array.isArray(e)){let i=new Set(e.flat(1/0).reverse());for(let r of i)t.unshift(fe(r))}else e!==void 0&&t.push(fe(e));return t}static _$Eh(e,t){let i=t.attribute;return i===!1?void 0:typeof i=="string"?i:typeof e=="string"?e.toLowerCase():void 0}o(){var e;this._$Ep=new Promise(t=>this.enableUpdating=t),this._$AL=new Map,this._$Em(),this.requestUpdate(),(e=this.constructor.l)===null||e===void 0||e.forEach(t=>t(this))}addController(e){var t,i;((t=this._$Eg)!==null&&t!==void 0?t:this._$Eg=[]).push(e),this.renderRoot!==void 0&&this.isConnected&&((i=e.hostConnected)===null||i===void 0||i.call(e))}removeController(e){var t;(t=this._$Eg)===null||t===void 0||t.splice(this._$Eg.indexOf(e)>>>0,1)}_$Em(){this.constructor.elementProperties.forEach((e,t)=>{this.hasOwnProperty(t)&&(this._$Et.set(t,this[t]),delete this[t])})}createRenderRoot(){var e;let t=(e=this.shadowRoot)!==null&&e!==void 0?e:this.attachShadow(this.constructor.shadowRootOptions);return ke(t,this.constructor.elementStyles),t}connectedCallback(){var e;this.renderRoot===void 0&&(this.renderRoot=this.createRenderRoot()),this.enableUpdating(!0),(e=this._$Eg)===null||e===void 0||e.forEach(t=>{var i;return(i=t.hostConnected)===null||i===void 0?void 0:i.call(t)})}enableUpdating(e){}disconnectedCallback(){var e;(e=this._$Eg)===null||e===void 0||e.forEach(t=>{var i;return(i=t.hostDisconnected)===null||i===void 0?void 0:i.call(t)})}attributeChangedCallback(e,t,i){this._$AK(e,i)}_$ES(e,t,i=Ce){var r,o;let n=this.constructor._$Eh(e,i);if(n!==void 0&&i.reflect===!0){let c=((o=(r=i.converter)===null||r===void 0?void 0:r.toAttribute)!==null&&o!==void 0?o:_e.toAttribute)(t,i.type);this._$Ei=e,c==null?this.removeAttribute(n):this.setAttribute(n,c),this._$Ei=null}}_$AK(e,t){var i,r,o;let n=this.constructor,c=n._$Eu.get(e);if(c!==void 0&&this._$Ei!==c){let d=n.getPropertyOptions(c),p=d.converter,S=(o=(r=(i=p)===null||i===void 0?void 0:i.fromAttribute)!==null&&r!==void 0?r:typeof p=="function"?p:null)!==null&&o!==void 0?o:_e.fromAttribute;this._$Ei=c,this[c]=S(t,d.type),this._$Ei=null}}requestUpdate(e,t,i){let r=!0;e!==void 0&&(((i=i||this.constructor.getPropertyOptions(e)).hasChanged||Ie)(this[e],t)?(this._$AL.has(e)||this._$AL.set(e,t),i.reflect===!0&&this._$Ei!==e&&(this._$E_===void 0&&(this._$E_=new Map),this._$E_.set(e,i))):r=!1),!this.isUpdatePending&&r&&(this._$Ep=this._$EC())}async _$EC(){this.isUpdatePending=!0;try{await this._$Ep}catch(t){Promise.reject(t)}let e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){var e;if(!this.isUpdatePending)return;this.hasUpdated,this._$Et&&(this._$Et.forEach((r,o)=>this[o]=r),this._$Et=void 0);let t=!1,i=this._$AL;try{t=this.shouldUpdate(i),t?(this.willUpdate(i),(e=this._$Eg)===null||e===void 0||e.forEach(r=>{var o;return(o=r.hostUpdate)===null||o===void 0?void 0:o.call(r)}),this.update(i)):this._$EU()}catch(r){throw t=!1,this._$EU(),r}t&&this._$AE(i)}willUpdate(e){}_$AE(e){var t;(t=this._$Eg)===null||t===void 0||t.forEach(i=>{var r;return(r=i.hostUpdated)===null||r===void 0?void 0:r.call(i)}),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$EU(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$Ep}shouldUpdate(e){return!0}update(e){this._$E_!==void 0&&(this._$E_.forEach((t,i)=>this._$ES(i,this[i],t)),this._$E_=void 0),this._$EU()}updated(e){}firstUpdated(e){}};D.finalized=!0,D.elementProperties=new Map,D.elementStyles=[],D.shadowRootOptions={mode:"open"},He==null||He({ReactiveElement:D}),((Ee=globalThis.reactiveElementVersions)!==null&&Ee!==void 0?Ee:globalThis.reactiveElementVersions=[]).push("1.0.2");var Ae,V=globalThis.trustedTypes,De=V?V.createPolicy("lit-html",{createHTML:s=>s}):void 0,U=`lit$${(Math.random()+"").slice(9)}$`,Ue="?"+U,Ut=`<${Ue}>`,W=document,oe=(s="")=>W.createComment(s),ne=s=>s===null||typeof s!="object"&&typeof s!="function",Oe=Array.isArray,Ot=s=>{var e;return Oe(s)||typeof((e=s)===null||e===void 0?void 0:e[Symbol.iterator])=="function"},ae=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,ze=/-->/g,je=/>/g,F=/>|[ 	\n\r](?:([^\s"'>=/]+)([ 	\n\r]*=[ 	\n\r]*(?:[^ 	\n\r"'`<>=]|("|')|))|$)/g,Be=/'/g,qe=/"/g,Fe=/^(?:script|style|textarea)$/i,Ge=s=>(e,...t)=>({_$litType$:s,strings:e,values:t}),m=Ge(1),O=Ge(2),I=Symbol.for("lit-noChange"),y=Symbol.for("lit-nothing"),Ze=new WeakMap,Ve=(s,e,t)=>{var i,r;let o=(i=t==null?void 0:t.renderBefore)!==null&&i!==void 0?i:e,n=o._$litPart$;if(n===void 0){let c=(r=t==null?void 0:t.renderBefore)!==null&&r!==void 0?r:null;o._$litPart$=n=new X(e.insertBefore(oe(),c),c,void 0,t??{})}return n._$AI(s),n},J=W.createTreeWalker(W,129,null,!1),zt=(s,e)=>{let t=s.length-1,i=[],r,o=e===2?"<svg>":"",n=ae;for(let d=0;d<t;d++){let p=s[d],S,f,x=-1,P=0;for(;P<p.length&&(n.lastIndex=P,f=n.exec(p),f!==null);)P=n.lastIndex,n===ae?f[1]==="!--"?n=ze:f[1]!==void 0?n=je:f[2]!==void 0?(Fe.test(f[2])&&(r=RegExp("</"+f[2],"g")),n=F):f[3]!==void 0&&(n=F):n===F?f[0]===">"?(n=r??ae,x=-1):f[1]===void 0?x=-2:(x=n.lastIndex-f[2].length,S=f[1],n=f[3]===void 0?F:f[3]==='"'?qe:Be):n===qe||n===Be?n=F:n===ze||n===je?n=ae:(n=F,r=void 0);let pe=n===F&&s[d+1].startsWith("/>")?" ":"";o+=n===ae?p+Ut:x>=0?(i.push(S),p.slice(0,x)+"$lit$"+p.slice(x)+U+pe):p+U+(x===-2?(i.push(void 0),d):pe)}let c=o+(s[t]||"<?>")+(e===2?"</svg>":"");return[De!==void 0?De.createHTML(c):c,i]},Y=class{constructor({strings:e,_$litType$:t},i){let r;this.parts=[];let o=0,n=0,c=e.length-1,d=this.parts,[p,S]=zt(e,t);if(this.el=Y.createElement(p,i),J.currentNode=this.el.content,t===2){let f=this.el.content,x=f.firstChild;x.remove(),f.append(...x.childNodes)}for(;(r=J.nextNode())!==null&&d.length<c;){if(r.nodeType===1){if(r.hasAttributes()){let f=[];for(let x of r.getAttributeNames())if(x.endsWith("$lit$")||x.startsWith(U)){let P=S[n++];if(f.push(x),P!==void 0){let pe=r.getAttribute(P.toLowerCase()+"$lit$").split(U),me=/([.?@])?(.*)/.exec(P);d.push({type:1,index:o,name:me[2],strings:pe,ctor:me[1]==="."?Je:me[1]==="?"?Ye:me[1]==="@"?Ke:le})}else d.push({type:6,index:o})}for(let x of f)r.removeAttribute(x)}if(Fe.test(r.tagName)){let f=r.textContent.split(U),x=f.length-1;if(x>0){r.textContent=V?V.emptyScript:"";for(let P=0;P<x;P++)r.append(f[P],oe()),J.nextNode(),d.push({type:2,index:++o});r.append(f[x],oe())}}}else if(r.nodeType===8)if(r.data===Ue)d.push({type:2,index:o});else{let f=-1;for(;(f=r.data.indexOf(U,f+1))!==-1;)d.push({type:7,index:o}),f+=U.length-1}o++}}static createElement(e,t){let i=W.createElement("template");return i.innerHTML=e,i}};function K(s,e,t=s,i){var r,o,n,c;if(e===I)return e;let d=i!==void 0?(r=t._$Cl)===null||r===void 0?void 0:r[i]:t._$Cu,p=ne(e)?void 0:e._$litDirective$;return(d==null?void 0:d.constructor)!==p&&((o=d==null?void 0:d._$AO)===null||o===void 0||o.call(d,!1),p===void 0?d=void 0:(d=new p(s),d._$AT(s,t,i)),i!==void 0?((n=(c=t)._$Cl)!==null&&n!==void 0?n:c._$Cl=[])[i]=d:t._$Cu=d),d!==void 0&&(e=K(s,d._$AS(s,e.values),d,i)),e}var We=class{constructor(e,t){this.v=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}p(e){var t;let{el:{content:i},parts:r}=this._$AD,o=((t=e==null?void 0:e.creationScope)!==null&&t!==void 0?t:W).importNode(i,!0);J.currentNode=o;let n=J.nextNode(),c=0,d=0,p=r[0];for(;p!==void 0;){if(c===p.index){let S;p.type===2?S=new X(n,n.nextSibling,this,e):p.type===1?S=new p.ctor(n,p.name,p.strings,this,e):p.type===6&&(S=new Xe(n,this,e)),this.v.push(S),p=r[++d]}c!==(p==null?void 0:p.index)&&(n=J.nextNode(),c++)}return o}m(e){let t=0;for(let i of this.v)i!==void 0&&(i.strings!==void 0?(i._$AI(e,i,t),t+=i.strings.length-2):i._$AI(e[t])),t++}},X=class{constructor(e,t,i,r){var o;this.type=2,this._$AH=y,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=i,this.options=r,this._$Cg=(o=r==null?void 0:r.isConnected)===null||o===void 0||o}get _$AU(){var e,t;return(t=(e=this._$AM)===null||e===void 0?void 0:e._$AU)!==null&&t!==void 0?t:this._$Cg}get parentNode(){let e=this._$AA.parentNode,t=this._$AM;return t!==void 0&&e.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=K(this,e,t),ne(e)?e===y||e==null||e===""?(this._$AH!==y&&this._$AR(),this._$AH=y):e!==this._$AH&&e!==I&&this.$(e):e._$litType$!==void 0?this.T(e):e.nodeType!==void 0?this.S(e):Ot(e)?this.M(e):this.$(e)}A(e,t=this._$AB){return this._$AA.parentNode.insertBefore(e,t)}S(e){this._$AH!==e&&(this._$AR(),this._$AH=this.A(e))}$(e){this._$AH!==y&&ne(this._$AH)?this._$AA.nextSibling.data=e:this.S(W.createTextNode(e)),this._$AH=e}T(e){var t;let{values:i,_$litType$:r}=e,o=typeof r=="number"?this._$AC(e):(r.el===void 0&&(r.el=Y.createElement(r.h,this.options)),r);if(((t=this._$AH)===null||t===void 0?void 0:t._$AD)===o)this._$AH.m(i);else{let n=new We(o,this),c=n.p(this.options);n.m(i),this.S(c),this._$AH=n}}_$AC(e){let t=Ze.get(e.strings);return t===void 0&&Ze.set(e.strings,t=new Y(e)),t}M(e){Oe(this._$AH)||(this._$AH=[],this._$AR());let t=this._$AH,i,r=0;for(let o of e)r===t.length?t.push(i=new X(this.A(oe()),this.A(oe()),this,this.options)):i=t[r],i._$AI(o),r++;r<t.length&&(this._$AR(i&&i._$AB.nextSibling,r),t.length=r)}_$AR(e=this._$AA.nextSibling,t){var i;for((i=this._$AP)===null||i===void 0||i.call(this,!1,!0,t);e&&e!==this._$AB;){let r=e.nextSibling;e.remove(),e=r}}setConnected(e){var t;this._$AM===void 0&&(this._$Cg=e,(t=this._$AP)===null||t===void 0||t.call(this,e))}},le=class{constructor(e,t,i,r,o){this.type=1,this._$AH=y,this._$AN=void 0,this.element=e,this.name=t,this._$AM=r,this.options=o,i.length>2||i[0]!==""||i[1]!==""?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=y}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(e,t=this,i,r){let o=this.strings,n=!1;if(o===void 0)e=K(this,e,t,0),n=!ne(e)||e!==this._$AH&&e!==I,n&&(this._$AH=e);else{let c=e,d,p;for(e=o[0],d=0;d<o.length-1;d++)p=K(this,c[i+d],t,d),p===I&&(p=this._$AH[d]),n||(n=!ne(p)||p!==this._$AH[d]),p===y?e=y:e!==y&&(e+=(p??"")+o[d+1]),this._$AH[d]=p}n&&!r&&this.k(e)}k(e){e===y?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}},Je=class extends le{constructor(){super(...arguments),this.type=3}k(e){this.element[this.name]=e===y?void 0:e}},jt=V?V.emptyScript:"",Ye=class extends le{constructor(){super(...arguments),this.type=4}k(e){e&&e!==y?this.element.setAttribute(this.name,jt):this.element.removeAttribute(this.name)}},Ke=class extends le{constructor(e,t,i,r,o){super(e,t,i,r,o),this.type=5}_$AI(e,t=this){var i;if((e=(i=K(this,e,t,0))!==null&&i!==void 0?i:y)===I)return;let r=this._$AH,o=e===y&&r!==y||e.capture!==r.capture||e.once!==r.once||e.passive!==r.passive,n=e!==y&&(r===y||o);o&&this.element.removeEventListener(this.name,this,r),n&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){var t,i;typeof this._$AH=="function"?this._$AH.call((i=(t=this.options)===null||t===void 0?void 0:t.host)!==null&&i!==void 0?i:this.element,e):this._$AH.handleEvent(e)}},Xe=class{constructor(e,t,i){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(e){K(this,e)}};var Qe=window.litHtmlPolyfillSupport;Qe==null||Qe(Y,X),((Ae=globalThis.litHtmlVersions)!==null&&Ae!==void 0?Ae:globalThis.litHtmlVersions=[]).push("2.0.2");var Se,Te;var b=class extends D{constructor(){super(...arguments),this.renderOptions={host:this},this._$Dt=void 0}createRenderRoot(){var e,t;let i=super.createRenderRoot();return(e=(t=this.renderOptions).renderBefore)!==null&&e!==void 0||(t.renderBefore=i.firstChild),i}update(e){let t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Dt=Ve(t,this.renderRoot,this.renderOptions)}connectedCallback(){var e;super.connectedCallback(),(e=this._$Dt)===null||e===void 0||e.setConnected(!0)}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this._$Dt)===null||e===void 0||e.setConnected(!1)}render(){return I}};b.finalized=!0,b._$litElement$=!0,(Se=globalThis.litElementHydrateSupport)===null||Se===void 0||Se.call(globalThis,{LitElement:b});var et=globalThis.litElementPolyfillSupport;et==null||et({LitElement:b});((Te=globalThis.litElementVersions)!==null&&Te!==void 0?Te:globalThis.litElementVersions=[]).push("3.0.2");var v=s=>e=>typeof e=="function"?((t,i)=>(window.customElements.define(t,i),i))(s,e):((t,i)=>{let{kind:r,elements:o}=i;return{kind:r,elements:o,finisher(n){window.customElements.define(t,n)}}})(s,e);var Bt=(s,e)=>e.kind==="method"&&e.descriptor&&!("value"in e.descriptor)?{...e,finisher(t){t.createProperty(e.key,s)}}:{kind:"field",key:Symbol(),placement:"own",descriptor:{},originalKey:e.key,initializer(){typeof e.initializer=="function"&&(this[e.key]=e.initializer.call(this))},finisher(t){t.createProperty(e.key,s)}};function u(s){return(e,t)=>t!==void 0?((i,r,o)=>{r.constructor.createProperty(o,i)})(s,e,t):Bt(s,e)}function _(s){return u({...s,state:!0})}var Q=({finisher:s,descriptor:e})=>(t,i)=>{var r;if(i===void 0){let o=(r=t.originalKey)!==null&&r!==void 0?r:t.key,n=e!=null?{kind:"method",placement:"prototype",key:o,descriptor:e(t.key)}:{...t,key:o};return s!=null&&(n.finisher=function(c){s(c,o)}),n}{let o=t.constructor;e!==void 0&&Object.defineProperty(t,i,e(i)),s==null||s(o,i)}};function C(s,e){return Q({descriptor:t=>{let i={get(){var r,o;return(o=(r=this.renderRoot)===null||r===void 0?void 0:r.querySelector(s))!==null&&o!==void 0?o:null},enumerable:!0,configurable:!0};if(e){let r=typeof t=="symbol"?Symbol():"__"+t;i.get=function(){var o,n;return this[r]===void 0&&(this[r]=(n=(o=this.renderRoot)===null||o===void 0?void 0:o.querySelector(s))!==null&&n!==void 0?n:null),this[r]}}return i}})}var T=h`:where(img, svg) {
...
::slotted(img) {
    ...
    cursor: pointer;
        ...
        `}};z.styles=[w,T,tt],a([u({type:String})],z.prototype,"pageName",2),a([u({type:Boolean})],z.prototype,"extension",2),a([u({type:String})],z.prototype,"title",2),a([u({type:Boolean})],z.prototype,"editing",2),z=a([v("nav-item")],z);var it=h`:host {
    flex-shrink: 0;
...
#items-container::-webkit-scrollbar-track {
    background-color: transparent;
        ...
        `}};$.styles=it,$.defaultPages=[{page:"daily-timetable",title:"Daily Timetable",icon:"images/dailytimetable.svg"},{page:"barcode",title:"ID Barcode",icon:"images/barcode.svg"},{page:"timetable",title:"Timetable",icon:"images/timetable.svg"},{page:"announcements",title:"Announcements",icon:"images/announcements.svg"},{page:"pages",title:"Pages Marketplace",icon:"images/marketplace.svg"},{page:"settings",title:"Settings",icon:"images/settings.svg"}],a([u({type:Boolean})],$.prototype,"editing",2),a([C("#items-container",!0)],$.prototype,"itemsContainer",2),$=a([v("nav-bar")],$);var k=class{};k.installedExtensions=new Map(Object.entries(JSON.parse(localStorage.getItem("Installed Extensions")||"{}"))),k._extensionCallbacks=new H,k._resourceListeners=new Map;function qt(){let s=[];for(let e of k.installedExtensions.values())s.push(new URL(e.url).origin);return s}async function st(s){let e=(await Me()).get(s);if(e){k.installedExtensions.set(s,e),localStorage.setItem("Installed Extensions",JSON.stringify(Object.fromEntries(k.installedExtensions)));let t=$.GetNavbarOrder();t.splice(t.length-1,0,t.length),$.SetNavbarOrder(t)}}async function ot(s){let e=k.installedExtensions,t=$.GetNavbarOrder(),i=t.indexOf(Object.keys(e).indexOf(s))+$.defaultPages.length,r=t.splice(i,1)[0];for(let n=0;n<t.length;n++)t[n]>r&&t[n]--;$.SetNavbarOrder(t);var o=document.getElementById(`extension-${s}`);o!==null&&o.remove(),k.installedExtensions.delete(s),localStorage.setItem("Installed Extensions",JSON.stringify(Object.fromEntries(k.installedExtensions)))}async function Me(){let e=await(await caches.open("Metadata")).match("Metadata");return e?new Map(Object.entries((await e.json()).pages||{})):new Map}async function nt(s){k._extensionCallbacks.AddListener(s),s(await Me())}async function at(){let s=await Me();k._extensionCallbacks.Invoke(s)}function lt(s){let e=new URL(s.icon,s.url);return e.search=`cache-version=${s.version}`,e.toString()}function rt(s){let e=new URL(s.navIcon,s.url);return e.searchParams.set("cache-version",s.version),e.toString()}function dt(){g.ListenForDark(e=>{for(let t=0;t<window.frames.length;t++)window.frames[t].postMessage({command:"Set Dark",data:{dark:e}},"*")}),g.ListenForHue(e=>{for(let t=0;t<window.frames.length;t++)window.frames[t].postMessage({command:"Set Hue",data:{hue:e}},"*")}),window.addEventListener("message",async e=>{let t=e.origin;!qt().includes(t)||e.source?.postMessage(await s(e),{targetOrigin:t})});async function s(e){let t=e.data.command,i=e.data.data;if(t=="Initialise")return{command:"Initialise",data:{dark:g.dark,hue:g.hue,version:await g.GetVersion()}};if(t=="Get Resource"){let r=k._resourceListeners.get(i.name),o=!1;r===void 0&&(o=!0,r=[]),r.push(e),k._resourceListeners.set(i.name,r),o&&E.GetResource(i.name,c=>{let d=k._resourceListeners.get(i.name)??[];for(let p of d)p.source?.postMessage({command:"Resource",data:{name:i.name,resource:c}},{targetOrigin:p.origin})});let n=await E.GetResourceNow(i.name);return{command:"Resource",data:{name:i.name,resource:n}}}if(t=="Get Token"){let r=await E.GetToken();return{command:"Token",data:{token:r.token===null?null:r.token.access_token,valid:r.valid}}}if(t=="Refresh Token"){if(!await E.FetchResources())return{command:"Refreshed Token",data:{token:null,valid:!1}};let o=await E.GetToken();return{command:"Refreshed Token",data:{token:o.token===null?null:o.token.access_token,valid:o.valid}}}if(t=="Show Notification"){if(i.loader&&typeof i.id!="string")return;let r=g.ShowNotification(i.contents,i.loader??!1);r.id=i.id;return}if(t=="Close Notification"){let r=document.getElementById(i.id);r!==null&&"Close"in r&&typeof r.Close=="function"&&r.Close();return}return t=="Ping"?{command:"Pong"}:{command:"Unknown Command",data:{command:t}}}}var g=class{static NavigateTo(e){if(e.extension){let t=k.installedExtensions;if(t.has(e.page)){let i=document.getElementById(`extension-${e.page}`);if(i===null){let r=document.createElement("extension-page");r.src=t.get(e.page).url,r.id=`extension-${e.page}`,document.querySelector("main")?.appendChild(r),i=r}this.SetPage(e,i)}}else this.SetPage(e,document.getElementById(e.page))}static SetPage(e,t){if(t){this._pageElement!=null&&this._pageElement.classList.add("hidden"),t.classList.remove("hidden"),this._pageElement=t,this.page=e,location.hash=e.extension?`extension-${e.page}`:e.page;let i=document.querySelector("nav-bar");i.removeAttribute("editing"),i.requestUpdate?.()}}static ShowNotification(e,t=!1){let i=document.createElement("inline-notification");return typeof e=="string"?i.innerText=e:i.appendChild(e),i.loader=t,document.getElementById("notification-area")?.appendChild(i),i}static SetDark(e){this.dark=e,document.documentElement.classList.toggle("dark",e),localStorage.setItem("Dark",e.toString()),this._darkCallbacks.Invoke(e)}static ListenForDark(e){this._darkCallbacks.AddListener(e)}static SetHue(e){document.documentElement.style.setProperty("--main-hue",e),document.documentElement.style.setProperty("--hue-rotate",`${parseFloat(e)-200}deg`),this.hue=e}static SaveHue(){localStorage.setItem("Hue",this.hue),this._hueCallbacks.Invoke(parseFloat(this.hue))}static ListenForHue(e){this._hueCallbacks.AddListener(e)}static async GetVersion(){var e=await caches.open("Metadata");let t=await e.match("Metadata");if(t)return(await t.json()).version}};g.page={page:"",extension:!1},g.dark=localStorage.getItem("Dark")=="true",g.hue=localStorage.getItem("Hue")||"200",g._pageElement=null,g._darkCallbacks=new H,g._hueCallbacks=new H;var L=class extends b{constructor(){super(...arguments);this._state=0;this._unreceivedResources=0;this._uncompletedResources=0}AddResource(e,t){this._unreceivedResources++,this._uncompletedResources++;let i=!1,r=!1;E.GetResource(e,o=>{i||(this._unreceivedResources--,i=!0),o!=null&&(r||(this._uncompletedResources--,r=!0),this[t]=o),this._uncompletedResources==0?this._state=2:this._unreceivedResources==0&&(this._state=1)})}render(){return this._state==0?y:this._state==1?m`
            ...
            `:this.renderPage()}renderPage(){return y}};a([_()],L.prototype,"_state",2);var ct={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},ht=s=>(...e)=>({_$litDirective$:s,values:e}),Re=class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,i){this._$Ct=e,this._$AM=t,this._$Ci=i}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}};var ve=class extends Re{constructor(e){if(super(e),this.it=y,e.type!==ct.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(e){if(e===y||e==null)return this.vt=void 0,this.it=e;if(e===I)return e;if(typeof e!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(e===this.it)return this.vt;this.it=e;let t=[e];return t.raw=t,this.vt={_$litType$:this.constructor.resultType,strings:t,values:[]}}};ve.directiveName="unsafeHTML",ve.resultType=1;var pt=ht(ve);var mt=h`:host {
    display: block;
}
...
announcement-post {
    margin-bottom: 1.2rem;
}`;var G=class extends L{constructor(){super();this.yearFilter="all";this.searchFilter="";this.AddResource("announcements","announcements")}renderPage(){let e=this.announcements.notices??[],t=this.yearFilter=="all"?e:e.filter(i=>(i.years??[]).includes(this.yearFilter));return t=this.searchFilter==""?t:t.filter(i=>{let r=i.title,o=i.content;return r==null||o===void 0||o===null?!1:r.toLowerCase().includes(this.searchFilter.toLowerCase())||o.toLowerCase().includes(this.searchFilter.toLowerCase())}),m`
        <div class="header">
        ...
        <div class="content">${t.map(i=>{let r=i.isMeeting==1,o=i.meetingDate??"";return new Date().toISOString().split("T")[0]==o&&(o=""),m`
            ...
            `})}</div>
        `}};G.styles=[w,T,be,ut,R,ee,gt],a([_()],G.prototype,"announcements",2),a([_()],G.prototype,"yearFilter",2),a([_()],G.prototype,"searchFilter",2),G=a([v("school-announcements")],G);var ft=h`:host {
    position: relative;
    display: block;
}
...
.background {
    ...
    clip-path: polygon(0 0, 100% 100%, 0 100%);
        ...
        `}};te.styles=[T,ft],a([C("slot")],te.prototype,"info",2),a([C(".background")],te.prototype,"background",2),te=a([v("info-popup")],te);var bt=h`:host {
    position: relative;
...
#save > svg {
    ...
    height: inherit;
        ...
        `}};j.styles=[w,T,R,ee,bt],a([C("#barcodeDisplay")],j.prototype,"barcode",2),a([C("#point1")],j.prototype,"point1",2),a([C("#point2")],j.prototype,"point2",2),a([C("#save")],j.prototype,"saveLink",2),j=a([v("student-barcode")],j);var xt=h`:host {
    display: flex;
    justify-content: space-between;
...
.changed {
    color: var(--text2);
            ...
            <p>${this.title}</p>
            <p>${this.time}</p>
        `}};ie.styles=[w,xt],a([u()],ie.prototype,"title",2),a([u()],ie.prototype,"time",2),ie=a([v("daily-timetable-bell")],ie);var wt=h`:host {
    display: flex;
    align-items: center;
    justify-content: space-between;
...
.periods {
    ...
    width: 80%;
        ...
        `;return this._dailyTimetableChanged=!1,this._savedPeriodsHtml=p,S}};B.styles=[w,R,ye,$t],B.updatingData=!1,a([_()],B.prototype,"_dailyTimetable",2),B=a([v("daily-timetable")],B);var kt=h`:host {
    overflow: hidden;
    display: flex;
    align-items: center;
    justify-content: center;
...
iframe {
    ...
    border: none;
        ...
        `}};Z.styles=_t,a([u({type:String})],Z.prototype,"src",2),a([C("iframe",!0)],Z.prototype,"frame",2),a([C("loading-indicator",!0)],Z.prototype,"loader",2),Z=a([v("extension-page")],Z);var we=h`a.button {
    text-decoration: none;
    cursor: default;
}
...
.content {
    ...
    flex: 1;
}`;var q=class extends b{async Install(){await st(this.title),document.getElementById("pages").requestUpdate()}async Uninstall(){await ot(this.title),document.getElementById("pages").requestUpdate()}render(){return m`
        <img src="${this.img}">
        ...
        `}};q.styles=[w,we,Ct],a([u()],q.prototype,"title",2),a([u()],q.prototype,"img",2),a([u()],q.prototype,"description",2),a([u({type:Boolean})],q.prototype,"installed",2),q=a([v("extension-display")],q);var At=h`:host {
    display: flex;
    flex-direction: column;
    gap: 1.2rem;
...
.content:empty::after {
    ...
    font-size: 1.4rem;
}`;var ce=class extends b{constructor(){super();this.fetchingExtensions=!0;this.extensions=new Map;nt(e=>{this.fetchingExtensions=!1,this.extensions=e})}render(){let e=k.installedExtensions,t=[];for(var i of e.keys())t.push(i);return m`
        <div class="header">
        ...
        `)}</div>
        `}
        `}};ce.styles=[w,be,R,ee,At],a([_()],ce.prototype,"extensions",2),ce=a([v("extensions-marketplace")],ce);var St=h`:host {
    position: relative;
    display: flex;
    align-items: flex-start;
    justify-content: space-between;
...
svg {
    width: inherit;
    height: inherit;
}`;var Tt=O`<svg width="220" height="220" viewBox="0 0 220 220" xmlns="http://www.w3.org/2000/svg"><g fill="none" stroke="#323232" stroke-width="10" stroke-linecap="round"><path d="m5 5 210 210M215 5 5 215"/></g></svg>`;var he=class extends b{constructor(){super(...arguments);this.Close=this.remove.bind(this)}render(){return m`
        <slot></slot>
        ${this.loader?m`
        ...
        `}};he.styles=[T,St],a([u({type:Boolean})],he.prototype,"loader",2),he=a([v("inline-notification")],he);var Mt=h`:where(input[type=range]) {
    appearance: none;
    width: 7rem;
...
info-popup {
    ...
    z-index: 2;
        ...
        `}};re.styles=[w,T,we,Mt,ye,R,Rt],a([C("#hue",!0)],re.prototype,"hueInput",2),a([_()],re.prototype,"version",2),re=a([v("user-settings")],re);var Pt=h`:host {
    position: relative;
    display: flex;
    align-items: center;
    justify-content: center;
...
:host(:focus) > p {
    ...
    box-shadow: 0 0 0 0.2rem var(--text1) !important;
        ...
        `}};A.styles=[w,Pt],A.instances=[],a([u()],A.prototype,"name",2),a([u()],A.prototype,"room",2),A=a([v("timetable-period")],A);var Lt=h`:host {
    margin: auto;
    padding: 1.6rem;
    max-width: 92%;
    width: 25.2rem;
