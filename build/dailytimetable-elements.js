...
`;class r extends t{static get styles(){return s}static get properties(){return{name:{type:String},time:{type:String}}}constructor(){super(),this.name="",this.time="00:00"}render(){return i`
        ...
        `}}class m extends t{static get styles(){return l}static get properties(){return{data:{type:Object}}}getDate(e){var t=new Date(this.data.date),i=e.time.split(":"),a=Number.parseInt(i[0]),s=Number.parseInt(i[1]);return t.setHours(a),t.setMinutes(s),t}getNextBell(){var e=new Date;for(var t in this.data.bells){var i=this.data.bells[t],a=this.getDate(i);if(a>=e)return{bell:i,time:Math.round((a-e)/1e3)}}}secondsToString(e){var t=e%60,i=(e-t)/60%60,a=((e-t)/60-i)/60;a<10&&(a="0"+a),i<10&&(i="0"+i),t<10&&(t="0"+t);var s="";return"00"!==a&&(s+=a+":"),s+=i+":"+t}updateCountdown(){var e=this.getNextBell();e?(e.bell.bell in this.data.timetable.timetable.periods&&"R"!=e.bell.bell?this.nextBell=this.data.timetable.timetable.periods[e.bell.bell].title:this.nextBell=e.bell.bellDisplay,this.timeUntilNextBell=this.secondsToString(e.time)):m.gettingNextDay||(m.gettingNextDay=!0,caches.open("User Resources").then((async e=>{var t=await e.match("next-dailytimetable");if(t){var i=t.clone();await e.put("dailytimetable",i);var a=await t.text();await e.delete("next-dailytimetable"),this.setAttribute("data",a)}else{this.setAttribute("data","null"),this.data=null,this.requestUpdate();var s=await LoginIfNeeded();if(await UpdateResourcesIfNeeded(s,!0)){i=(await e.match("dailytimetable")).clone();this.setAttribute("data",await i.text())}}})))}static gettingNextDay=!1;constructor(){super(),this.nextBell="Nothing",this.timeUntilNextBell="00:00",setInterval((()=>{this.data&&(this.updateCountdown(),this.update())}),1e3),this.data={date:"",bells:[],timetable:{timetable:{periods:{}},subjects:{}},roomVariations:[],classVariations:[]}}render(){return this.data?(this.updateCountdown(),i`
            <p>${this.nextBell}</p>
            <p>in</p>
