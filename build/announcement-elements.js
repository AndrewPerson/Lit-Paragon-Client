...
const announcementContainerCss = i$3`
    :host {
        display: flex;
...
class AnnouncementItem extends h {
    static get styles() {
...
class AnnouncementContainer extends h {
    static get styles() {
...
export { AnnouncementContainer, AnnouncementItem };
