...
***************************************************************************** */function S(){for(var e=0,t=0,r=arguments.length;t<r;t++)e+=arguments[t].length;var i=Array(e),n=0;for(t=0;t<r;t++)for(var s=arguments[t],a=0,o=s.length;a<o;a++,n++)i[n]=s[a];return i}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */!function(e){e[e.DEBUG=0]="DEBUG",e[e.VERBOSE=1]="VERBOSE",e[e.INFO=2]="INFO",e[e.WARN=3]="WARN",e[e.ERROR=4]="ERROR",e[e.SILENT=5]="SILENT"}(E||(E={}));var k={debug:E.DEBUG,verbose:E.VERBOSE,info:E.INFO,warn:E.WARN,error:E.ERROR,silent:E.SILENT},O=E.INFO,A=((I={})[E.DEBUG]="log",I[E.VERBOSE]="log",I[E.INFO]="info",I[E.WARN]="warn",I[E.ERROR]="error",I),N=function(e,t){for(var r=[],i=2;i<arguments.length;i++)r[i-2]=arguments[i];if(!(t<e.logLevel)){var n=(new Date).toISOString(),s=A[t];if(!s)throw new Error("Attempted to log a message with an invalid logType (value: "+t+")");console[s].apply(console,S(["["+n+"]  "+e.name+":"],r))}},C=function(){function e(e){this.name=e,this._logLevel=O,this._logHandler=N,this._userLogHandler=null}return Object.defineProperty(e.prototype,"logLevel",{get:function(){return this._logLevel},set:function(e){if(!(e in E))throw new TypeError('Invalid value "'+e+'" assigned to `logLevel`');this._logLevel=e},enumerable:!1,configurable:!0}),e.prototype.setLogLevel=function(e){this._logLevel="string"==typeof e?k[e]:e},Object.defineProperty(e.prototype,"logHandler",{get:function(){return this._logHandler},set:function(e){if("function"!=typeof e)throw new TypeError("Value assigned to `logHandler` must be a function");this._logHandler=e},enumerable:!1,configurable:!0}),Object.defineProperty(e.prototype,"userLogHandler",{get:function(){return this._userLogHandler},set:function(e){this._userLogHandler=e},enumerable:!1,configurable:!0}),e.prototype.debug=function(){for(var e=[],t=0;t<arguments.length;t++)e[t]=arguments[t];this._userLogHandler&&this._userLogHandler.apply(this,S([this,E.DEBUG],e)),this._logHandler.apply(this,S([this,E.DEBUG],e))},e.prototype.log=function(){for(var e=[],t=0;t<arguments.length;t++)e[t]=arguments[t];this._userLogHandler&&this._userLogHandler.apply(this,S([this,E.VERBOSE],e)),this._logHandler.apply(this,S([this,E.VERBOSE],e))},e.prototype.info=function(){for(var e=[],t=0;t<arguments.length;t++)e[t]=arguments[t];this._userLogHandler&&this._userLogHandler.apply(this,S([this,E.INFO],e)),this._logHandler.apply(this,S([this,E.INFO],e))},e.prototype.warn=function(){for(var e=[],t=0;t<arguments.length;t++)e[t]=arguments[t];this._userLogHandler&&this._userLogHandler.apply(this,S([this,E.WARN],e)),this._logHandler.apply(this,S([this,E.WARN],e))},e.prototype.error=function(){for(var e=[],t=0;t<arguments.length;t++)e[t]=arguments[t];this._userLogHandler&&this._userLogHandler.apply(this,S([this,E.ERROR],e)),this._logHandler.apply(this,S([this,E.ERROR],e))},e}();
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var W;z(new b("platform-logger",(e=>new R(e)),"PRIVATE")),j("@firebase/app","0.7.0",W),j("fire-js","");function V(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}
/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function oe(e,t,r,i,n={}){return ce(e,n,(()=>{let n={},s={};i&&("GET"===t?s=i:n={body:JSON.stringify(i)});const a=m(Object.assign({key:e.config.apiKey},s)).slice(1),o=new(ne.headers());return o.set("Content-Type","application/json"),o.set("X-Client-Version",e._getSdkClientVersion()),e.languageCode&&o.set("X-Firebase-Locale",e.languageCode),ne.fetch()(le(e,e.config.apiHost,r,a),Object.assign({method:t,headers:o,referrerPolicy:"no-referrer"},n))}))}async function ce(e,t,r){e._canInitEmulator=!1;const i=Object.assign(Object.assign({},se),t);try{const t=new he(e),n=await Promise.race([r(),t.promise]);t.clearNetworkTimeout();const s=await n.json();if("needConfirmation"in s)throw ue(e,"account-exists-with-different-credential",s);if(n.ok&&!("errorMessage"in s))return s;{const t=n.ok?s.errorMessage:s.error.message,[r,a]=t.split(" : ");if("FEDERATED_USER_ID_ALREADY_LINKED"===r)throw ue(e,"credential-already-in-use",s);if("EMAIL_EXISTS"===r)throw ue(e,"email-already-in-use",s);const o=i[r]||r.toLowerCase().replace(/[_\s]+/g,"-");if(a)throw function(e,t,r){const i=Object.assign(Object.assign({},B()),{[t]:r});return new u("auth","Firebase",i).create(t,{appName:e.name})}(e,o,a);G(e,o)}}catch(t){if(t instanceof h)throw t;G(e,"network-request-failed")}}function le(e,t,r,i){const n=`${t}${r}?${i}`;return e.config.emulator?function(e,t){Z(e.emulator,"Emulator should always be set here");const{url:r}=e.emulator;return t?`${r}${t.startsWith("/")?t.slice(1):t}`:r}(e.config,n):`${e.config.apiScheme}://${n}`}class he{constructor(e){this.auth=e,this.timer=null,this.promise=new Promise(((e,t)=>{this.timer=setTimeout((()=>t(J(this.auth,"timeout"))),ae.get())}))}clearNetworkTimeout(){clearTimeout(this.timer)}}function ue(e,t,r){const i={appName:e.name};r.email&&(i.email=r.email),r.phoneNumber&&(i.phoneNumber=r.phoneNumber);const n=J(e,t,i);return n.customData._tokenResponse=r,n}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
async function me(e,t,r=!1){if(r)return t;try{return await t}catch(t){throw t instanceof h&&function({code:e}){return"auth/user-disabled"===e||"auth/user-token-expired"===e}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Se(e,t,r){return`firebase:${e}:${t}:${r}`}class ke{constructor(e,t,r){this.persistence=e,this.auth=t,this.userKey=r;const{config:i,name:n}=this.auth;this.fullUserKey=Se(this.userKey,i.apiKey,n),this.fullPersistenceKey=Se("persistence",i.apiKey,n),this.boundEventHandler=t._onStorageEvent.bind(t),this.persistence._addListener(this.fullUserKey,this.boundEventHandler)}setCurrentUser(e){return this.persistence._set(this.fullUserKey,e.toJSON())}async getCurrentUser(){const e=await this.persistence._get(this.fullUserKey);return e?Ie._fromJSON(this.auth,e):null}removeCurrentUser(){return this.persistence._remove(this.fullUserKey)}savePersistenceForRedirect(){return this.persistence._set(this.fullPersistenceKey,this.persistence.type)}async setPersistence(e){if(this.persistence===e)return;const t=await this.getCurrentUser();return await this.removeCurrentUser(),this.persistence=e,t?this.setCurrentUser(t):void 0}delete(){this.persistence._removeListener(this.fullUserKey,this.boundEventHandler)}static async create(e,t,r="authUser"){if(!t.length)return new ke(ee(Te),e,r);const i=(await Promise.all(t.map((async e=>{if(await e._isAvailable())return e})))).filter((e=>e));let n=i[0]||ee(Te);const s=Se(r,e.config.apiKey,e.name);let a=null;for(const r of t)try{const t=await r._get(s);if(t){const i=Ie._fromJSON(e,t);r!==n&&(a=i),n=r;break}}catch(e){}const o=i.filter((e=>e._shouldAllowMigration));return n._shouldAllowMigration&&o.length?(n=o[0],a&&await n._set(s,a.toJSON()),await Promise.all(t.map((async e=>{if(e!==n)try{await e._remove(s)}catch(e){}}))),new ke(n,e,r)):new ke(n,e,r)}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
