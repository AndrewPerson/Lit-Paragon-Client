 ...
 */class At extends nt{static get styles(){return[kt,ft]}static get properties(){return{page:{type:String},title:{type:String},icon:{type:String}}}UpdatePage(){location.hash=this.page,""!=location.pathname&&(location.pathname=""),window.UpdatePage(),window.UpdateScreenType()}constructor(){super(),this.page="",this.title="Home",this.icon="",Ht.NavItems.push(this)}render(){return this.icon||(this.icon=this.title.toLowerCase()),window.page==this.page?this.classList.add("nav-selected"):this.classList.remove("nav-selected"),O`
        ...
        `}}class Ht extends nt{static get styles(){return bt}static get properties(){return{pages:{type:Array},titles:{type:Array},icons:{type:Array},order:{type:Array}}}updatePage(){for(var t of Ht.NavItems)t.requestUpdate()}static NavItems=[];constructor(){super(),this.pages=[],this.titles=[],this.icons=[],this.order=[0,1,2,3,4,6,7,8,9,10,5]}createRenderRoot(){var t=super.createRenderRoot();return t.addEventListener("pointerdown",(()=>{this.classList.add("hover")})),t.addEventListener("pointerup",(()=>{this.classList.remove("hover")})),t}render(){return mt(this.order,(t=>t),((t,e)=>{var s;return s=0==t?O`<nav-item page="dailytimetable" title="Daily Timetable" icon="dailytimetable"></nav-item>`:1==t?O`<nav-item page="barcode" title="ID Barcode" icon="barcode"></nav-item>`:2==t?O`<nav-item page="timetable" title="Timetable"></nav-item>`:3==t?O`<nav-item page="announcements" title="Announcements"></nav-item>`:4==t?O`<nav-item page="pages" title="Pages Marketplace" icon="marketplace"></nav-item>`:5==t?O`<nav-item page="settings" title="Settings"></nav-item>`:O`<nav-page-item page="${this.pages[t-6]}" title="${this.titles[t-6]}" icon="${this.icons[t-6]}"></nav-page-item>`,e==this.order.length-1&&(s=O`<div class="end">${s}</div>`),s}))}}class Nt extends nt{static get styles(){return yt}static get properties(){return{width:{type:String},height:{type:String}}}constructor(){super(),this.width="0",this.height="0"}render(){return O`
            <img draggable="false" class="spinner" src="images/rings.svg" />
        `}}class Rt extends nt{static get styles(){return[xt,Pt,$t,wt]}async login(){await caches.delete("User Resources"),location.pathname="login"}constructor(){super()}render(){return O`
        ...
        `}}customElements.define("nav-item",At),customElements.define("nav-page-item",Tt),customElements.define("nav-bar",Ht),customElements.define("loading-element",Nt),customElements.define("login-notification",Rt);export{B as A,Nt as L,At as N,O as T,mt as a,kt as b,xt as c,rt as d,ot as e,St as f,Ut as g,nt as h,r as i,Ct as j,$t as k,Et as l,Tt as m,Ht as n,Rt as o,at as s,Pt as t,M as w};
